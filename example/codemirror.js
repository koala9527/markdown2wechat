    ...
    77: function(e, t, r) {
        e.exports = function() {
            ...
            var K = function() {
                ...
                this.f = null,
                this.time = 0,
                this.handler = G(this.onTimeout, this)
            };
            function j(e, t) {
            ...
            K.prototype.onTimeout = function(e) {
                e.id = 0,
            ...
            K.prototype.set = function(e, t) {
                this.f = t;
                var r = +new Date + e;
                (!this.id || r < this.time) && (clearTimeout(this.id),
            ...
            function ne(e, t) {
                var r;
                return Object.create ? r = Object.create(e) : (re.prototype = e,
                r = new re),
                t && U(t, r),
                r
            }
            var ie = /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/;
            function oe(e) {
                return /\w/.test(e) || e > "\x80" && (e.toUpperCase() != e.toLowerCase() || ie.test(e))
            }
            function le(e, t) {
            ...
            function ce(e, t, r) {
                for (; (r < 0 ? t > 0 : t < e.length) && ue(e.charAt(t)); )
                    t += r;
                return t
            }
            function he(e, t, r) {
            ...
            function de(e, t, r) {
                ...
                for (var i = 0; i < e.length; ++i) {
                    ...
                    if (o.from < t && o.to > t)
                        return i;
                    o.to == t && (o.from != o.to && "before" == r ? n = i : fe = i),
                    o.from == t && (o.from != o.to && "before" != r ? n = i : fe = i)
                }
                return null != n ? n : fe
            }
            var pe = function() {
                ...
                return function(a, u) {
                    ...
                    if (0 == a.length || "ltr" == u && !r.test(a))
                        return !1;
                    for (var f = a.length, d = [], p = 0; p < f; ++p)
                        d.push((c = a.charCodeAt(p)) <= 247 ? e.charAt(c) : 1424 <= c && c <= 1524 ? "R" : 1536 <= c && c <= 1785 ? t.charAt(c - 1536) : 1774 <= c && c <= 2220 ? "r" : 8192 <= c && c <= 8203 ? "w" : 8204 == c ? "b" : "L");
                    for (var g = 0, v = h; g < f; ++g) {
                        var m = d[g];
                        "m" == m ? d[g] = v : v = m
                    }
                    for (var y = 0, b = h; y < f; ++y) {
                        var w = d[y];
                        "1" == w && "r" == b ? d[y] = "n" : i.test(w) && (b = w,
                        "r" == w && (d[y] = "R"))
                    }
                    for (var x = 1, C = d[0]; x < f - 1; ++x) {
                        var S = d[x];
                        "+" == S && "1" == C && "1" == d[x + 1] ? d[x] = "1" : "," != S || C != d[x + 1] || "1" != C && "n" != C || (d[x] = C),
                        C = S
                    }
                    for (var L = 0; L < f; ++L) {
                        var k = d[L];
                        if ("," == k)
                            ...
                            for (T = L + 1; T < f && "%" == d[T]; ++T)
                                ;
                            for (var M = L && "!" == d[L - 1] || T < f && "1" == d[T] ? "1" : "N", N = L; N < T; ++N)
                                d[N] = M;
                            L = T - 1
                        }
                    }
                    for (var O = 0, A = h; O < f; ++O) {
                        var D = d[O];
                    ...
                    for (var W = 0; W < f; ++W)
                        if (n.test(d[W])) {
                            ...
                            for (H = W + 1; H < f && n.test(d[H]); ++H)
                                ;
                            for (var F = "L" == (W ? d[W - 1] : h), P = "L" == (H < f ? d[H] : h), E = F == P ? F ? "L" : "R" : h, R = W; R < H; ++R)
                                d[R] = E;
                            W = H - 1
                        }
                    for (var z, I = [], B = 0; B < f; )
                        if (o.test(d[B])) {
                            ...
                            for (var j = U; j < B; )
                                if (l.test(d[j])) {
                                    U < j && (I.splice(V, 0, new s(1,U,j)),
                                    V += K);
                                    var X = j;
                                    for (++j; j < B && l.test(d[j]); ++j)
                                        ;
                                    I.splice(V, 0, new s(2,X,j)),
                                    V += K,
                                    U = j
                                } else
                                    ++j;
                            U < B && I.splice(V, 0, new s(1,U,B))
                        }
                    return "ltr" == u && (1 == I[0].level && (z = a.match(/^\s+/)) && (I[0].from = z[0].length,
                    I.unshift(new s(0,0,z[0].length))),
                    1 == ee(I).level && (z = a.match(/\s+$/)) && (ee(I).to -= z[0].length,
                    I.push(new s(0,f - z[0].length,f)))),
                    "rtl" == u ? I.reverse() : I
                }
            }();
            function ge(e, t) {
                var r = e.order;
                return null == r && (r = e.order = pe(e.text, t)),
                r
            }
            var ve = []
              , me = function(e, t, r) {
            ...
            function Fe(e) {
                if (null == De) {
                    ...
                    0 != e.firstChild.offsetHeight && (De = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(l && s < 8))
                }
                var r = De ? A("span", "\u200b") : A("span", "\xa0", null, "display: inline-block; width: 1px; margin-right: -1px");
            ...
            function Pe(e) {
                ...
                return N(e),
                !(!r || r.left == r.right) && (We = n.right - r.right < 3)
            }
            var Ee = 3 != "\n\nb".split(/\n/).length ? function(e) {
            ...
            : function(e) {
              ...
              , Ge = {};
            function Ue(e) {
                if ("string" == typeof e && Ge.hasOwnProperty(e))
                    e = Ge[e];
                else if (e && "string" == typeof e.name && Ge.hasOwnProperty(e.name)) {
                    var t = Ge[e.name];
                    "string" == typeof t && (t = {
                        name: t
                    }),
                    (e = ne(t, e)).name = t.name
                } else {
            ...
            function et(e) {
                if (null == e.parent)
                    return null;
                for (var t = e.parent, r = j(t.lines, e), n = t.parent; n; t = n,
                n = n.parent)
            ...
            function ht(e, t) {
                ...
                return t.line > r ? it(r, qe(e, r).text.length) : function(e, t) {
                    var r = e.ch;
            ...
            _e.prototype.column = function() {
                return this.lastColumnPos < this.start && (this.lastColumnValue = V(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue),
                this.lastColumnPos = this.start),
                this.lastColumnValue - (this.lineStart ? V(this.string, this.lineStart, this.tabSize) : 0)
            }
            ,
            ...
            ,
            _e.prototype.match = function(e, t, r) {
                if ("string" != typeof e) {
            ...
            function gt(e, t, r, n) {
                var i = [e.state.modeGen]
                  , o = {};
                Lt(e, t.text, e.doc.mode, r, function(e, t) {
                    return i.push(e, t)
                }, o, n);
                for (var l = r.state, s = function(n) {
                    ...
                    var s = e.state.overlays[n]
                      ...
                      , u = 0;
                    r.state = !0,
                    Lt(e, t.text, s.mode, r, function(e, t) {
                        for (var r = a; u < e; ) {
                            var n = i[a];
            ...
            function mt(e, t, r) {
                ...
                var o = function(e, t, r) {
                    for (var n, i, o = e.doc, l = r ? -1 : t - (e.doc.mode.innerMode ? 1e3 : 100), s = t; s > l; --s) {
                        ...
                        var a = qe(o, s - 1)
                          , u = a.stateAfter;
                        if (u && (!r || s + (u instanceof dt ? u.lookAhead : 0) <= o.modeFrontier))
                            return s;
                        var c = V(a.text, null, e.options.tabSize);
                        (null == i || n > c) && (i = s - 1,
                        n = c)
                    }
                    return i
                  ...
                  , s = l ? pt.fromSaved(n, l, o) : new pt(n,$e(n.mode),o);
                return n.iter(o, t, function(r) {
                    yt(e, r.text, s);
                    var n = s.line;
                    r.stateAfter = n == t - 1 || n % 5 == 0 || n >= i.viewFrom && n < i.viewTo ? s.save() : null,
                    s.nextLine()
                }),
            ...
            function yt(e, t, r, n) {
                var i = e.doc.mode
                  , o = new _e(t,e.options.tabSize,r);
                for (o.start = o.pos = n || 0,
                "" == t && bt(i, r.state); !o.eol(); )
                    wt(i, o, r.state),
                    o.start = o.pos
            }
            function bt(e, t) {
            ...
            pt.fromSaved = function(e, t, r) {
                return t instanceof dt ? new pt(e,Xe(e.mode, t.state),r,t.lookAhead) : new pt(e,Xe(e.mode, t),r)
            }
            ,
            ...
            function Ct(e, t, r, n) {
                var i, o = e.doc, l = o.mode;
                t = ht(o, t);
                var s, a = qe(o, t.line), u = mt(e, t.line, r), c = new _e(a.text,e.options.tabSize,u);
                for (n && (s = []); (n || c.pos < t.ch) && !c.eol(); )
                    c.start = c.pos,
                    i = wt(l, c, u.state),
                    n && s.push(new xt(c,i,Xe(o.mode, u.state)));
                return n ? s : new xt(c,i,u.state)
            }
            function St(e, t) {
                if (e)
                    for (; ; ) {
            ...
            function Lt(e, t, r, n, i, o, l) {
                ...
                var a, u = 0, c = null, h = new _e(t,e.options.tabSize,n), f = e.options.addModeClass && [null];
                for ("" == t && St(bt(r, n.state), o); !h.eol(); ) {
                    if (h.pos > e.options.maxHighlightLength ? (s = !1,
                    l && yt(e, t, n, h.pos),
                    h.pos = t.length,
                    a = null) : a = St(wt(r, h, n.state, f), o),
                    f) {
                        var d = f[0].name;
                        d && (a = "m-" + (a ? d + " " + a : d))
                    }
                    ...
                    if (e)
                        for (var i = 0; i < e.length; ++i) {
                            ...
                            if (s || o.from == t && "bookmark" == l.type && (!r || !o.marker.insertLeft)) {
                                ...
                                (n || (n = [])).push(new Mt(l,o.from,a ? null : o.to))
                            }
                        }
                    return n
                }(r, i, l)
                    ...
                    if (e)
                        for (var i = 0; i < e.length; ++i) {
                            ...
                            if (s || o.from == t && "bookmark" == l.type && (!r || o.marker.insertLeft)) {
                                ...
                                (n || (n = [])).push(new Mt(l,a ? null : o.from - t,null == o.to ? null : o.to - t))
                            }
                        }
                    return n
                }(n, o, l)
                ...
                if (!u) {
                    ...
                    if (b > 0 && s)
                        for (var w = 0; w < s.length; ++w)
                            null == s[w].to && (y || (y = [])).push(new Mt(s[w].marker,null,null));
                    for (var x = 0; x < b; ++x)
                        m.push(y);
                    m.push(a)
                }
            ...
            function Et(e, t) {
                ...
                var n = e.find()
                  , i = t.find()
                  , o = ot(n.from, i.from) || Ft(e) - Ft(t);
                if (o)
                    return -o;
                var l = ot(n.to, i.to) || Pt(e) - Pt(t);
                return l || t.id - e.id
            }
            function Rt(e, t) {
                var r, n = Tt && e.markedSpans;
                if (n)
                    for (var i = void 0, o = 0; o < n.length; ++o)
                        (i = n[o]).marker.collapsed && null == (t ? i.from : i.to) && (!r || Et(r, i.marker) < 0) && (r = i.marker);
                return r
            }
            function zt(e) {
                return Rt(e, !0)
            ...
            function Bt(e, t) {
                ...
                if (n)
                    for (var i = 0; i < n.length; ++i) {
                        var o = n[i];
                        o.marker.collapsed && (null == o.from || o.from < t) && (null == o.to || o.to > t) && (!r || Et(r, o.marker) < 0) && (r = o.marker)
                    }
                return r
            }
                    ...
                    for (var s = 0; s < l.length; ++s) {
                        ...
                        if (a.marker.collapsed) {
                            var u = a.marker.find(0)
                              , c = ot(u.from, r) || Ft(a.marker) - Ft(i)
                              , h = ot(u.to, n) || Pt(a.marker) - Pt(i);
                            if (!(c >= 0 && h <= 0 || c <= 0 && h >= 0) && (c <= 0 && (a.marker.inclusiveRight && i.inclusiveLeft ? ot(u.to, r) >= 0 : ot(u.to, r) > 0) || c >= 0 && (a.marker.inclusiveRight && i.inclusiveLeft ? ot(u.from, n) <= 0 : ot(u.from, n) < 0)))
                                return !0
                        }
                    }
            }
            ...
            function jt(e, t) {
                var r = Tt && t.markedSpans;
                if (r)
                    for (var n = void 0, i = 0; i < r.length; ++i)
                        if ((n = r[i]).marker.collapsed) {
                            if (null == n.from)
                                return !0;
                            if (!n.marker.widgetNode && 0 == n.from && n.marker.inclusiveLeft && Xt(e, t, n))
                                return !0
                        }
            }
            function Xt(e, t, r) {
                if (null == r.to) {
                    ...
                    return Xt(e, n.line, Nt(n.line.markedSpans, r.marker))
                }
                if (r.marker.inclusiveRight && r.to == t.text.length)
                    return !0;
                for (var i = void 0, o = 0; o < t.markedSpans.length; ++o)
                    if ((i = t.markedSpans[o]).marker.collapsed && !i.marker.widgetNode && i.from == r.to && (null == i.to || i.to != r.from) && (i.marker.inclusiveLeft || r.marker.inclusiveRight) && Xt(e, t, i))
                        return !0
            }
            function Yt(e) {
                e = Ut(e);
            ...
            function tr(e, t) {
                ...
                for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
                    ...
                    n.pos = 0,
                    n.addToken = nr,
                    Pe(e.display.measure) && (l = ge(o, e.doc.direction)) && (n.addToken = ir(n.addToken, l)),
                    n.map = [];
                    var s = t != e.display.externalMeasured && et(o);
                    lr(o, n, vt(e, o, s)),
                    o.styleClasses && (o.styleClasses.bgClass && (n.bgClass = P(o.styleClasses.bgClass, n.bgClass || "")),
                    o.styleClasses.textClass && (n.textClass = P(o.styleClasses.textClass, n.textClass || ""))),
                    0 == n.map.length && n.map.push(0, 0, n.content.appendChild(Fe(e.display.measure))),
                ...
                return we(e, "renderLine", e, t.line, n.pre),
            ...
            function nr(e, t, r, n, i, o, a) {
                if (t) {
                        ...
                        for (var d = 0; ; ) {
                            ...
                            if ("\t" == p[0]) {
                                var y = e.cm.options.tabSize
                                  , b = y - e.col % y;
                                (m = u.appendChild(A("span", Q(b), "cm-tab"))).setAttribute("role", "presentation"),
                                m.setAttribute("cm-text", "\t"),
                                e.col += b
                            } else
                                "\r" == p[0] || "\n" == p[0] ? ((m = u.appendChild(A("span", "\r" == p[0] ? "\u240d" : "\u2424", "cm-invalidchar"))).setAttribute("cm-text", p[0]),
                                e.col += 1) : ((m = e.cm.options.specialCharPlaceholder(p[0])).setAttribute("cm-text", p[0]),
                    ...
                    r || n || i || f || o || a) {
                        ...
                        if (a)
                            for (var C in a)
                                a.hasOwnProperty(C) && "style" != C && "class" != C && x.setAttribute(C, a[C]);
                ...
                if (n)
                    for (var l, s, a, u, c, h, f, d = i.length, p = 0, g = 1, v = "", m = 0; ; ) {
                        if (m == p) {
                            ...
                            for (var y = [], b = void 0, w = 0; w < n.length; ++w) {
                                ...
                                if ("bookmark" == C.type && x.from == p && C.widgetNode)
                                    ...
                                    C.collapsed && (!h || Et(h.marker, C) < 0) && (h = x)
                                } else
                            ...
                            if (!h || h.from == p)
                                for (var k = 0; k < y.length; ++k)
                                    or(t, 0, y[k]);
                            if (h && (h.from || 0) == p) {
                                if (or(t, (null == h.to ? d + 1 : h.to) - p, h.marker, null == h.from),
                                null == h.to)
                                    return;
                                h.to == p && (h = !1)
                            }
                        ...
                        for (var T = Math.min(d, m); ; ) {
                            ...
                            v = i.slice(o, o = r[g++]),
                            l = er(r[g++], t.cm.options)
                        }
                    }
                else
                    for (var O = 1; O < r.length; O += 2)
                        t.addToken(t, i.slice(o, o = r[O]), er(r[O + 1], t.cm.options))
            }
            function sr(e, t, r) {
                this.line = t,
                ...
                this.size = this.rest ? et(ee(this.rest)) - r + 1 : 1,
                this.node = this.text = null,
                this.hidden = jt(e, t)
            }
            function ar(e, t, r) {
                for (var n, i = [], o = t; o < r; o = n) {
                    var l = new sr(e.doc,qe(e.doc, o),o);
                    n = o + l.size,
                    i.push(l)
                }
                return i
            ...
            function hr(e, t) {
                ...
                if (r.length) {
                    ...
                    ur ? n = ur.delayedCallbacks : cr ? n = cr : (n = cr = [],
                    setTimeout(fr, 0));
            ...
            function dr(e, t, r, n) {
                for (var i = 0; i < t.changes.length; i++) {
                    var o = t.changes[i];
                    "text" == o ? vr(e, t) : "gutter" == o ? yr(e, t, r, n) : "class" == o ? mr(e, t) : "widget" == o && br(e, t, n)
                }
                t.changes = null
            }
            function pr(e) {
            ...
            function mr(e, t) {
                ...
                t.line.wrapClass ? pr(t).className = t.line.wrapClass : t.node != t.text && (t.node.className = "");
            ...
            function yr(e, t, r, n) {
                ...
                if (e.options.lineNumbers || o) {
                    ...
                    !e.options.lineNumbers || o && o["CodeMirror-linenumbers"] || (t.lineNumber = s.appendChild(A("div", nt(e.options, r), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + n.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))),
                    o)
            ...
            function Cr(e, t, r, n, i) {
                if (t.widgets)
                    for (var o = pr(r), l = 0, s = t.widgets; l < s.length; ++l) {
                        var a = s[l]
            ...
            function kr(e, t) {
                for (var r = Oe(t); r != e.wrapper; r = r.parentNode)
            ...
            function Ar(e) {
                return e.display.scroller.clientWidth - Or(e) - e.display.barWidth
            }
            function Dr(e) {
                return e.display.scroller.clientHeight - Or(e) - e.display.barHeight
            }
            function Wr(e, t, r) {
                if (e.line == t)
                    return {
            ...
            function Hr(e, t, r, n) {
                return Er(e, Pr(e, t), r, n)
            }
            function Fr(e, t) {
                if (t >= e.display.viewFrom && t < e.display.viewTo)
                    return e.display.view[fn(e, t)];
                var r = e.display.externalMeasured;
            ...
            function Pr(e, t) {
                var r = et(t)
                  , n = Fr(e, r);
                n && !n.text ? n = null : n && n.changes && (dr(e, n, r, sn(e)),
                e.curOp.forceUpdate = !0),
                n || (n = function(e, t) {
                    var r = et(t = Ut(t))
                      , n = e.display.externalMeasured = new sr(e.doc,t,r);
                    n.lineN = r;
                    var i = n.built = tr(e, n);
                    return n.text = i.pre,
                    O(e.display.lineMeasure, i.pre),
                    n
                }(e, t));
                var i = Wr(n, t, r);
                return {
            ...
            function Er(e, t, r, n, i) {
                ...
                t.hasHeights = !0),
                (o = function(e, t, r, n) {
                    var i, o = Ir(t.map, r, n), a = o.node, u = o.start, c = o.end, h = o.collapse;
                    if (3 == a.nodeType) {
                        for (var f = 0; f < 4; f++) {
                            for (; u && ue(t.line.text.charAt(o.coverStart + u)); )
                                --u;
                            for (; o.coverStart + c < o.coverEnd && ue(t.line.text.charAt(o.coverStart + c)); )
                                ++c;
                            if ((i = l && s < 9 && 0 == u && c == o.coverEnd - o.coverStart ? a.parentNode.getBoundingClientRect() : Br(T(a, u, c).getClientRects(), n)).left || i.right || 0 == u)
                                break;
                            c = u,
                            u -= 1,
                            h = "right"
                    ...
                    return i.left || i.right || (C.bogus = !0),
                    e.options.singleCursorHeightPerLine || (C.rtop = g,
                    C.rbottom = v),
                    C
            ...
            function Ir(e, t, r) {
                for (var n, i, o, l, s, a, u = 0; u < e.length; u += 3)
                    ...
                    t < s ? (i = 0,
                    o = 1,
                    l = "left") : t < a ? o = 1 + (i = t - s) : (u == e.length - 3 || t == a && e[u + 3] > t) && (i = (o = a - s) - 1,
                    t >= a && (l = "right")),
                    null != i) {
                        if (n = e[u + 2],
            ...
            function Kr(e) {
                return c && m ? -(e.body.getBoundingClientRect().left - parseInt(getComputedStyle(e.body).marginLeft)) : e.defaultView.pageXOffset || (e.documentElement || e.body).scrollLeft
            }
            function jr(e) {
                return c && m ? -(e.body.getBoundingClientRect().top - parseInt(getComputedStyle(e.body).marginTop)) : e.defaultView.pageYOffset || (e.documentElement || e.body).scrollTop
            }
            function Xr(e) {
                var t = Ut(e)
                  , r = t.widgets
            ...
            function Yr(e, t, r, n, i) {
                ...
                n || (n = "local");
                var l = Yt(t);
                if ("local" == n ? l += Tr(e.display) : l -= e.display.viewOffset,
                "page" == n || "window" == n) {
                    var s = e.display.lineSpace.getBoundingClientRect();
                    l += s.top + ("window" == n ? 0 : jr(R(e)));
                    var a = s.left + ("window" == n ? 0 : Kr(R(e)));
                    r.left += a,
                    r.right += a
                }
                return r.top += l,
            ...
            function _r(e, t, r, n, i) {
                return n || (n = qe(e.doc, t.line)),
                Yr(e, n, Hr(e, n, t.ch, i), r)
            }
            function qr(e, t, r, n, i, o) {
                function l(t, l) {
                    var s = Er(e, i, t, l ? "right" : "left", o);
                    return l ? s.left = s.right : s.right = s.left,
                    Yr(e, n, s, r)
                }
                n = n || qe(e.doc, t.line),
                i || (i = Pr(e, n));
                var s = ge(n, e.doc.direction)
                  , a = t.ch
                  , u = t.sticky;
                if (a >= n.text.length ? (a = n.text.length,
                u = "before") : a <= 0 && (a = 0,
                u = "after"),
                !s)
                ...
                var h = de(s, a, u)
                  , f = fe
                  , d = c(a, h, "before" == u);
                return null != f && (d.other = c(a, f, "before" != u)),
                d
            }
            function Zr(e, t) {
                var r = 0;
                t = ht(e.doc, t),
                e.options.lineWrapping || (r = ln(e.display) * t.ch);
            ...
            function Qr(e, t, r) {
                ...
                if ((r += e.display.viewOffset) < 0)
                    return Jr(n.first, 0, null, -1, -1);
                var i = tt(n, r)
                  , o = n.first + n.size - 1;
                if (i > o)
                    return Jr(n.first + n.size - 1, qe(n, o).text.length, null, 1, 1);
                t < 0 && (t = 0);
                for (var l = qe(n, i); ; ) {
                    var s = nn(e, l, i, t, r)
                      , a = Bt(l, s.ch + (s.xRel > 0 || s.outside > 0 ? 1 : 0));
                    if (!a)
                        return s;
                    var u = a.find(1);
                    if (u.line == i)
            ...
            function tn(e, t, r, n) {
                r || (r = Pr(e, t));
                var i = Yr(e, t, Er(e, r, n), "line").top;
                return en(e, t, r, i)
            }
            function rn(e, t, r, n) {
            ...
            function nn(e, t, r, n, i) {
                ...
                if (c) {
                    var h = (e.options.lineWrapping ? function(e, t, r, n, i, o, l) {
                        ...
                        for (var c = null, h = null, f = 0; f < i.length; f++) {
                            ...
                            if (!(d.from >= u || d.to <= a)) {
                                var p = 1 != d.level
                                  , g = Er(e, n, p ? Math.min(u, d.to) - 1 : Math.max(a, d.from)).right
                                  , v = g < o ? o - g + 1e9 : g - o;
                                (!c || h > v) && (c = d,
                                h = v)
                            }
                        }
                        return c || (c = i[i.length - 1]),
                        c.from < a && (c = {
                            from: a,
                            to: c.to,
                            level: c.level
                    ...
                    : function(e, t, r, n, i, o, l) {
                        var s = he(function(s) {
                            var a = i[s]
                              , u = 1 != a.level;
                            return rn(qr(e, it(r, u ? a.to : a.from, u ? "before" : "after"), "line", t, n), o, l, !0)
                        }, 0, i.length - 1)
                          , a = i[s];
                        if (s > 0) {
                            var u = 1 != a.level
                              , c = qr(e, it(r, u ? a.from : a.to, u ? "after" : "before"), "line", t, n);
                            rn(c, o, l, !0) && c.top > l && (a = i[s - 1])
                        }
                        return a
                    }
                    )(e, t, r, o, c, n, i);
                ...
                var f, d, p = null, g = null, v = he(function(t) {
                    var r = Er(e, o, t);
                    return r.top += l,
                    r.bottom += l,
                    !!rn(r, n, i, !1) && (r.top <= i && r.left <= n && (p = t,
                    g = r),
                    !0)
                }, s, a), m = !1;
                if (g) {
                    ...
                    u || v != a && v != s || v++,
                    d = 0 == v ? "after" : v == t.text.length ? "before" : Er(e, o, v - (u ? 1 : 0)).bottom + l <= i == u ? "after" : "before";
                    var w = qr(e, it(r, v, d), "line", t, o);
                    f = w.left,
                    m = i < w.top ? -1 : i >= w.bottom ? 1 : 0
                }
                return v = ce(t.text, v, 1),
                Jr(r, v, d, m, n - f)
            }
            function on(e) {
            ...
            function hn(e, t, r, n) {
                var i = e.display;
                if (!r && "true" == Oe(t).getAttribute("cm-not-content"))
                    return null;
                ...
                if (n && u.xRel > 0 && (a = qe(e.doc, u.line).text).length == u.ch) {
                    var c = V(a, a.length, e.options.tabSize) - a.length;
                    u = it(u.line, Math.max(0, Math.round((o - Nr(e.display).left) / ln(e.display)) - c))
                }
                return u
            }
            function fn(e, t) {
            ...
            function dn(e, t, r, n) {
                ...
                t >= i.viewTo)
                    Tt && Vt(e.doc, t) < i.viewTo && gn(e);
                else if (r <= i.viewFrom)
                    Tt && Kt(e.doc, r + n) > i.viewFrom ? gn(e) : (i.viewFrom += n,
                    i.viewTo += n);
                    ...
                    i.viewTo = l.lineN) : gn(e)
                } else {
                    var s = vn(e, t, t, -1)
                      , a = vn(e, r, r + n, 1);
                    s && a ? (i.view = i.view.slice(0, s.index).concat(ar(e, s.lineN, a.lineN)).concat(i.view.slice(a.index)),
                    i.viewTo += n) : gn(e)
                }
            ...
            function vn(e, t, r, n) {
                var i, o = fn(e, t), l = e.display.view;
                if (!Tt || r == e.doc.first + e.doc.size)
                    return {
                        index: o,
                        lineN: r
                    };
                    ...
                    if (t || s != r.sel.primIndex) {
                        ...
                        if (!(a.from().line >= e.display.viewTo || a.to().line < e.display.viewFrom)) {
                            ...
                            if (l) {
                                ...
                                (u || e.options.showCursorWhenSelecting) && wn(e, a.head, i);
                            u || Cn(e, a, o)
                        }
                    }
                return n
            ...
            function wn(e, t, r) {
                ...
                if (n.other) {
                    ...
                    s.style.height = .85 * (n.other.bottom - n.other.top) + "px"
                }
            }
            function xn(e, t) {
            ...
            function Cn(e, t, r) {
                var n = e.display
                  ...
                  , l = Nr(e.display)
                  , s = l.left
                  , a = Math.max(n.sizerWidth, Ar(e) - n.sizer.offsetLeft) - l.right
                  , u = "ltr" == i.direction;
                function c(e, t, r, n) {
                    t < 0 && (t = 0),
                    t = Math.round(t),
                ...
                function h(t, r, n) {
                    var o, l, h = qe(i, t), f = h.text.length;
                    function d(r, n) {
                        return _r(e, it(t, r), "div", h, n)
                    }
                    function p(t, r, n) {
                        var i = tn(e, h, null, t)
                    ...
                    return function(e, t, r, n) {
                        ...
                        if (y.top - m.top <= 3) {
                            ...
                            N = u ? a : p(e, i, "before"),
                            O = u ? s : p(t, i, "after"),
                            A = u && w && C ? a : y.right) : (M = u ? p(e, i, "before") : s,
                            N = !u && b && x ? a : m.right,
                            O = !u && w && C ? s : y.left,
                            A = u ? p(t, i, "after") : a),
                            c(M, m.top, N - M, m.bottom),
                            m.bottom < y.top && c(s, m.bottom, null, y.top),
                            c(O, y.top, A - O, y.bottom)
                        }
                        (!o || xn(m, o) < 0) && (o = m),
                        xn(y, o) < 0 && (o = y),
                        (!l || xn(m, l) < 0) && (l = m),
                ...
                if (f.line == d.line)
                    ...
                    v && (m.top < y.top - 2 ? (c(m.right, m.top, null, m.bottom),
                    c(s, y.top, y.left, y.bottom)) : c(m.right, m.top, y.left - m.right, m.bottom)),
                    m.bottom < y.top && c(s, m.bottom, null, y.top)
                }
                r.appendChild(o)
            }
            ...
            function Mn(e, t) {
                e.state.delayingBlurEvent || (e.state.focused && (we(e, "blur", e, t),
                e.state.focused = !1,
                ...
                for (var t = e.display, r = t.lineDiv.offsetTop, n = Math.max(0, t.scroller.getBoundingClientRect().top), i = t.lineDiv.getBoundingClientRect().top, o = 0, a = 0; a < t.view.length; a++) {
                    ...
                    if (!u.hidden) {
                        ...
                        l && s < 8) {
                            ...
                            h = p.bottom - p.top,
                            !c && u.text.firstChild && (f = u.text.firstChild.getBoundingClientRect().right - p.left - 1)
                        }
                        var g = u.line.height - h;
                        if ((g > .005 || g < -.005) && (i < n && (o -= g),
                        Qe(u.line, h),
                        On(u.line),
                        u.rest))
                            for (var v = 0; v < u.rest.length; v++)
                                On(u.rest[v]);
                        if (f > e.display.sizerWidth) {
                            var m = Math.ceil(f / ln(e.display));
                            m > e.display.maxLineLength && (e.display.maxLineLength = m,
            ...
            function An(e, t, r) {
                ...
                if (r && r.ensure) {
                    var s = r.ensure.from.line
                      , a = r.ensure.to.line;
                    s < o ? (o = s,
                    l = tt(t, Yt(qe(t, s)) + e.wrapper.clientHeight)) : Math.min(a, t.lastLine()) >= l && (o = tt(t, Yt(qe(t, a)) - e.wrapper.clientHeight),
                    l = a)
                }
                return {
                    from: o,
            ...
            function Dn(e, t) {
                ...
                t.left < 10 ? l.scrollLeft = 0 : t.left < f ? l.scrollLeft = Math.max(0, t.left + h - (p ? 0 : 10)) : t.right > d + f - 3 && (l.scrollLeft = t.right + (p ? 0 : 10) - d),
                l
            }
            function Wn(e, t) {
                null != t && (Pn(e),
            ...
            function Rn(e, t) {
                Math.abs(e.doc.scrollTop - t) < 2 || (r || ui(e, {
                    top: t
                }),
                zn(e, t, !0),
                r && ui(e),
            ...
            function Bn(e) {
                var t = e.display
                  ...
                  , n = Math.round(e.doc.height + Mr(e.display));
                return {
                    ...
                    docHeight: n,
                    scrollHeight: n + Or(e) + t.barHeight,
            ...
            Gn.prototype.zeroWidthHack = function() {
                ...
                this.disableHoriz = new K,
                this.disableVert = new K
            }
            ,
            ...
            function Vn(e, t) {
                ...
                for (var i = 0; i < 4 && r != e.display.barWidth || n != e.display.barHeight; i++)
                    r != e.display.barWidth && e.options.lineWrapping && Nn(e),
                    Kn(e, Bn(e)),
            ...
            function Xn(e) {
                ...
                e.display.scrollbars = new jn[e.options.scrollbarStyle](function(t) {
                    e.display.wrapper.insertBefore(t, e.display.scrollbarFiller),
                    me(t, "mousedown", function() {
            ...
            function $n(e) {
                ...
                t = e.curOp,
                ur ? ur.ops.push(t) : t.ownsGroup = ur = {
                    ops: [t],
                    delayedCallbacks: []
                }
            }
                ...
                t && function(e, t) {
                    ...
                    !function(e) {
                        ...
                        for (var n = 0; n < t.length; n++)
                            (i = t[n]).updatedDisplay = i.mustUpdate && si(i.cm, i.update);
            ...
            function qn(e) {
                ...
                !function(e) {
                    ...
                    t.heightForcer.style.height = Or(e) + "px",
                    t.sizer.style.marginBottom = -t.nativeBarWidth + "px",
                    t.sizer.style.borderRightWidth = Or(e) + "px",
                    t.scrollbarsClipped = !0)
                }(t),
                e.updateMaxLine && _t(t),
                ...
                e.update = e.mustUpdate && new li(t,e.mustUpdate && {
                    top: e.scrollTop,
            ...
            function Zn(e) {
                ...
                e.barMeasure = Bn(t),
                r.maxLineChanged && !t.options.lineWrapping && (e.adjustWidthTo = Hr(t, r.maxLine, r.maxLine.text.length).left + 3,
                t.display.sizerWidth = e.adjustWidthTo,
                e.barMeasure.scrollWidth = Math.max(r.scroller.clientWidth, r.sizer.offsetLeft + e.adjustWidthTo + Or(t) + t.display.barWidth),
                e.maxScrollLeft = Math.max(0, r.sizer.offsetLeft + e.adjustWidthTo - Ar(t))),
            ...
            function Jn(e) {
                ...
                e.maxScrollLeft < t.doc.scrollLeft && In(t, Math.min(t.display.scroller.scrollLeft, e.maxScrollLeft), !0),
                t.display.maxLineChanged = !1);
                var r = e.focus && e.focus == H(z(t));
            ...
            function Qn(e) {
                var t = e.cm
                  , r = t.display
                  , n = t.doc;
                if (e.updatedDisplay && ai(t, e.update),
                ...
                null != e.scrollLeft && In(t, e.scrollLeft, !0, !0),
                e.scrollToPos) {
                    var i = function(e, t, r, n) {
                        var i;
                        null == n && (n = 0),
                        e.options.lineWrapping || t != r || (r = "before" == t.sticky ? it(t.line, t.ch + 1, "before") : t,
                        ...
                        for (var o = 0; o < 5; o++) {
                            ...
                            null != u.scrollLeft && (In(e, u.scrollLeft),
                            Math.abs(e.doc.scrollLeft - h) > 1 && (l = !0)),
                            !l)
                                break
                        }
                        return i
                    }(t, ht(n, e.scrollToPos.from), ht(n, e.scrollToPos.to), e.scrollToPos.margin);
                    !function(e, t) {
                        if (!xe(e, "scrollCursorIntoView")) {
                            ...
                            if (t.top + n.top < 0 ? i = !0 : t.bottom + n.top > (o.defaultView.innerHeight || o.documentElement.clientHeight) && (i = !1),
                            null != i && !g) {
                                var l = A("div", "\u200b", null, "position: absolute;\n                         top: " + (t.top - r.viewOffset - Tr(e.display)) + "px;\n                         height: " + (t.bottom - t.top + Or(e) + r.barHeight) + "px;\n                         left: " + t.left + "px; width: " + Math.max(2, t.right - t.left) + "px;");
                ...
                if (o)
                    for (var s = 0; s < o.length; ++s)
                        o[s].lines.length || we(o[s], "hide");
                if (l)
                    for (var a = 0; a < l.length; ++a)
                        l[a].lines.length && we(l[a], "unhide");
            ...
            function ii(e, t) {
                e.doc.highlightFrontier < e.display.viewTo && e.state.highlight.set(t, G(oi, e))
            }
            function oi(e) {
                var t = e.doc;
                if (!(t.highlightFrontier >= e.display.viewTo)) {
                    var r = +new Date + e.options.workTime
                      , n = mt(e, t.highlightFrontier)
                      , i = [];
                    t.iter(n.line, Math.min(t.first + t.size, e.display.viewTo + 500), function(o) {
                        if (n.line >= e.display.viewFrom) {
                            var l = o.styles
                              , s = o.text.length > e.options.maxHighlightLength ? Xe(t.mode, n.state) : null
                              , a = gt(e, o, n, !0);
                            s && (n.state = s),
                            o.styles = a.styles;
                            ...
                            for (var h = !l || l.length != o.styles.length || u != c && (!u || !c || u.bgClass != c.bgClass || u.textClass != c.textClass), f = 0; !h && f < l.length; ++f)
                                h = l[f] != o.styles[f];
                            h && i.push(n.line),
                            o.stateAfter = n.save(),
                            n.nextLine()
                        } else
                            o.text.length <= e.options.maxHighlightLength && yt(e, o.text, n),
                            o.stateAfter = n.line % 5 == 0 ? n.save() : null,
                            n.nextLine();
                        if (+new Date > r)
                            return ii(e, e.options.workDelay),
                            !0
                    }),
            ...
            function si(e, t) {
                ...
                if (t.editorIsHidden)
                    return gn(e),
                    !1;
                if (!t.force && t.visible.from >= r.viewFrom && t.visible.to <= r.viewTo && (null == r.updateLineNumbers || r.updateLineNumbers >= r.viewTo) && r.renderedView == r.view && 0 == mn(e))
                    return !1;
                di(e) && (gn(e),
                t.dims = sn(e));
                ...
                !function(e, t, r) {
                    var n = e.display;
                    0 == n.view.length || t >= n.viewTo || r <= n.viewFrom ? (n.view = ar(e, t, r),
                    n.viewFrom = t) : (n.viewFrom > t ? n.view = ar(e, t, n.viewFrom).concat(n.view) : n.viewFrom < t && (n.view = n.view.slice(fn(e, t))),
                    n.viewFrom = t,
                    n.viewTo < r ? n.view = n.view.concat(ar(e, n.viewTo, r)) : n.viewTo > r && (n.view = n.view.slice(0, fn(e, r)))),
                    n.viewTo = r
                }(e, o, l),
                r.viewOffset = Yt(qe(e.doc, r.viewFrom)),
                ...
                var c = function(e) {
                    ...
                    if (window.getSelection) {
                        var n = B(e).getSelection();
                        n.anchorNode && n.extend && W(e.display.lineDiv, n.anchorNode) && (r.anchorNode = n.anchorNode,
                ...
                function(e, t, r) {
                    ...
                    function s(t) {
                        var r = t.nextSibling;
                        return a && b && e.display.currentWheelTarget == t ? t.style.display = "none" : t.parentNode.removeChild(t),
                        r
                    }
                    for (var u = n.view, c = n.viewFrom, h = 0; h < u.length; h++) {
                        ...
                        if (f.hidden)
                            ...
                            dr(e, f, c, r)),
                            d && (N(f.lineNumber),
                            f.lineNumber.appendChild(document.createTextNode(nt(e.options, c)))),
                ...
                function(e) {
                    if (e && e.activeElt && e.activeElt != H(I(e.activeElt)) && (e.activeElt.focus(),
                    !/^(INPUT|TEXTAREA)$/.test(e.activeElt.nodeName) && e.anchorNode && W(document.body, e.anchorNode) && W(document.body, e.focusNode))) {
            ...
            function ai(e, t) {
                for (var r = t.viewport, n = !0; ; n = !1) {
                    if (n && e.options.lineWrapping && t.oldDisplayWidth != Ar(e))
                        ...
                        top: Math.min(e.doc.height + Mr(e.display) - Dr(e), r.top)
                    }),
            ...
            function ci(e) {
                ...
                hr(e, "gutterChanged", e)
            }
            function hi(e, t) {
                e.display.sizer.style.minHeight = t.docHeight + "px",
                e.display.heightForcer.style.top = t.docHeight + "px",
                e.display.gutters.style.height = t.docHeight + e.display.barHeight + Or(e) + "px"
            }
            function fi(e) {
                var t = e.display
                  , r = t.view;
            ...
            function mi(e, t, n, i) {
                ...
                o.lineSpace = D("div", [o.measure, o.lineMeasure, o.selectionDiv, o.cursorDiv, o.lineDiv], null, "position: relative; outline: none");
                var u = D("div", [o.lineSpace], "CodeMirror-lines");
                o.mover = A("div", [u], null, "position: relative"),
                o.sizer = A("div", [o.mover], "CodeMirror-sizer"),
                o.sizerWidth = null,
                o.heightForcer = A("div", null, null, "position: absolute; height: " + X + "px; width: 1px;"),
                ...
                l && s < 8 && (o.gutters.style.zIndex = -1,
            ...
            function Ci(e, t) {
                c && 102 == h && (null == e.display.chromeScrollHack ? e.display.sizer.style.pointerEvents = "none" : clearTimeout(e.display.chromeScrollHack),
                ...
                if (i && d || o && p) {
                    ...
                    if (i && !r && !f && null != l)
                        return o && p && Rn(e, Math.max(0, u.scrollTop + o * l)),
                        In(e, Math.max(0, u.scrollLeft + i * l)),
                        (!o || o && p) && ke(t),
                    ...
                    yi < 20 && 0 !== t.deltaMode && (null == s.wheelStartX ? (s.wheelStartX = u.scrollLeft,
            ...
            l ? bi = -.53 : r ? bi = 15 : c ? bi = -.7 : d && (bi = -1 / 3);
            var Si = function(e, t) {
                this.ranges = e,
                this.primIndex = t
            };
            ...
            Si.prototype.equals = function(e) {
                ...
                for (var t = 0; t < this.ranges.length; t++) {
                    var r = this.ranges[t]
                      , n = e.ranges[t];
                    if (!lt(r.anchor, n.anchor) || !lt(r.head, n.head))
                        return !1
                }
                return !0
            }
            ...
            Si.prototype.deepCopy = function() {
                for (var e = [], t = 0; t < this.ranges.length; t++)
                    e[t] = new Li(st(this.ranges[t].anchor),st(this.ranges[t].head));
            ...
            function ki(e, t, r) {
                ...
                for (var o = 1; o < t.length; o++) {
                    ...
                    if (n && !l.empty() ? a > 0 : a >= 0) {
                        ...
                        o <= r && --r,
                        t.splice(--o, 2, new Li(h ? c : u,h ? u : c))
                    }
                }
                return new Si(t,r)
            }
            function Ti(e, t) {
                return new Si([new Li(e,t || e)],0)
            }
            function Mi(e) {
                return e.text ? it(e.from.line + e.text.length - 1, ee(e.text).length + (1 == e.text.length ? e.from.ch : 0)) : e.to
            }
            function Ni(e, t) {
                if (ot(e, t.from) < 0)
                    return e;
                ...
                var r = e.line + t.text.length - (t.to.line - t.from.line) - 1
                  , n = e.ch;
                return e.line == t.to.line && (n += Mi(t).ch - t.to.ch),
                it(r, n)
            }
            function Oi(e, t) {
                for (var r = [], n = 0; n < e.sel.ranges.length; n++) {
                    var i = e.sel.ranges[n];
                    r.push(new Li(Ni(i.anchor, t),Ni(i.head, t)))
                }
            ...
            function Fi(e, t, r, n) {
                ...
                if (t.full)
                    ...
                    if (1 == u.length)
                        ...
                        v.push(new qt(f + c.text.slice(a.ch),d,n)),
            ...
            function Gi(e, t, r, n) {
                ...
                if ((i.lastOp == n || i.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && i.lastModTime > s - (e.cm ? e.cm.options.historyEventDelay : 500) || "*" == t.origin.charAt(0))) && (o = function(e, t) {
                    return t ? (Bi(e.done),
                    ee(e.done)) : e.done.length && !ee(e.done).ranges ? ee(e.done) : e.done.length > 1 && !e.done[e.done.length - 2].ranges ? (e.done.pop(),
                    ee(e.done)) : void 0
                }(i, i.lastOp == n)))
                    l = ee(o.changes),
                    0 == ot(t.from, t.to) && 0 == ot(t.from, l.to) ? l.to = Mi(t) : o.changes.push(Ii(e, t));
                else {
                    var a = ee(i.done);
                    for (a && a.ranges || Vi(e.sel, i.done),
                    o = {
                        changes: [Ii(e, t)],
            ...
            function Ui(e, t, r, n) {
                ...
                }(e, o, ee(i.done), t)) ? i.done[i.done.length - 1] = t : Vi(t, i.done),
            ...
            function Yi(e, t, r) {
                for (var n = [], i = 0; i < e.length; ++i) {
                    var o = e[i];
                    if (o.ranges)
                        n.push(r ? Si.prototype.deepCopy.call(o) : o);
                    else {
                        var l = o.changes
                          , s = [];
                        n.push({
                        ...
                        for (var a = 0; a < l.length; ++a) {
                            ...
                            t)
                                for (var h in u)
                                    (c = h.match(/^spans_(\d+)$/)) && j(t, Number(c[1])) > -1 && (ee(s)[h] = u[h],
                                    delete u[h])
                        }
                    }
                }
            ...
            function eo(e, t, r) {
                to(e, t, r),
                Ui(e, e.sel, e.cm ? e.cm.curOp.id : NaN, r)
            }
            function to(e, t, r) {
                (Se(e, "beforeSelectionChange") || e.cm && Se(e.cm, "beforeSelectionChange")) && (t = function(e, t, r) {
                    var n = {
                        ...
                        update: function(t) {
                            this.ranges = [];
                            for (var r = 0; r < t.length; r++)
                                this.ranges[r] = new Li(ht(e, t[r].anchor),ht(e, t[r].head))
                        },
                        origin: r && r.origin
                    };
                    return we(e, "beforeSelectionChange", e, n),
                    e.cm && we(e.cm, "beforeSelectionChange", e.cm, n),
                    n.ranges != t.ranges ? ki(e.cm, n.ranges, n.ranges.length - 1) : t
                }(e, t, r));
                var n = r && r.bias || (ot(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1);
                ro(e, io(e, t, n, !0)),
                r && !1 === r.scroll || !e.cm || "nocursor" == e.cm.getOption("readOnly") || Hn(e.cm)
            }
            function ro(e, t) {
                ...
                Ce(e.cm)),
                hr(e, "cursorActivity", e))
            }
            function no(e) {
                ro(e, io(e, e.sel, null, !1))
            }
            function io(e, t, r, n) {
                for (var i, o = 0; o < t.ranges.length; o++) {
                    var l = t.ranges[o]
                      , s = t.ranges.length == e.sel.ranges.length && e.sel.ranges[o]
                      , a = lo(e, l.anchor, s && s.anchor, r, n)
                      , u = l.head == l.anchor ? a : lo(e, l.head, s && s.head, r, n);
                        ...
                        if ((null == s.from || (u ? s.from <= t.ch : s.from < t.ch)) && (null == s.to || (c ? s.to >= t.ch : s.to > t.ch))) {
                            ...
                            if (r) {
                                var h = a.find(n < 0 ? 1 : -1)
                                  , f = void 0;
                                if ((n < 0 ? c : u) && (h = so(e, h, -n, h && h.line == t.line ? o : null)),
                                h && h.line == t.line && (f = ot(h, r)) && (n < 0 ? f < 0 : f > 0))
                                    return oo(e, h, t, n, i)
                            }
                            var d = a.find(n < 0 ? -1 : 1);
                            return (n < 0 ? u : c) && (d = so(e, d, n, d.line == t.line ? o : null)),
                            d ? oo(e, d, t, n, i) : null
                        }
                    }
                return t
            ...
            function lo(e, t, r, n, i) {
                var o = n || 1
                  , l = oo(e, t, r, o, i) || !i && oo(e, t, r, o, !0) || oo(e, t, r, -o, i) || !i && oo(e, t, r, -o, !0);
                return l || (e.cantEdit = !0,
                it(e.first, 0))
            }
            function so(e, t, r, n) {
                return r < 0 && 0 == t.ch ? t.line > e.first ? ht(e, it(t.line - 1)) : null : r > 0 && t.ch == (n || qe(e, t.line)).text.length ? t.line < e.first + e.size - 1 ? it(t.line + 1, 0) : null : new it(t.line,t.ch + r)
            }
            function ao(e) {
            ...
            function uo(e, t, r) {
                ...
                n.canceled ? (e.cm && (e.cm.curOp.updateInput = 2),
                null) : {
                    from: n.from,
                    to: n.to,
                    text: n.text,
            ...
            function co(e, t, r) {
                if (e.cm) {
                    if (!e.cm.curOp)
                        return ti(e.cm, co)(e, t, r);
                    if (e.cm.state.suppressEdits)
                        return
                }
                if (!(Se(e, "beforeChange") || e.cm && Se(e.cm, "beforeChange")) || (t = uo(e, t, !0))) {
                        ...
                        if (e.iter(t.line, r.line + 1, function(e) {
                            if (e.markedSpans)
                                for (var t = 0; t < e.markedSpans.length; ++t) {
                                    ...
                                    !r.readOnly || n && -1 != j(n, r) || (n || (n = [])).push(r)
                                }
                        }),
                        !n)
                            return null;
            ...
            function ho(e, t) {
                if (1 != t.text.length || "" != t.text[0] || 0 != ot(t.from, t.to)) {
                    var r = Oi(e, t);
                    Gi(e, t, r, e.cm ? e.cm.curOp.id : NaN),
                    go(e, t, r, At(e, t));
                    var n = [];
                    Pi(e, function(e, r) {
                        r || -1 != j(n, e.history) || (bo(e.history, t),
                        n.push(e.history)),
                        go(e, t, null, At(e, t))
                    })
                }
            ...
            function fo(e, t, r) {
                ...
                if (!n || r) {
                    ...
                    if (u != s.length) {
                        ...
                        for (var h = Se(e, "beforeChange") || e.cm && Se(e.cm, "beforeChange"), f = function(r) {
                            var n = i.changes[r];
                            if (n.origin = t,
                            h && !uo(e, n, !1))
                                return s.length = 0,
                            ...
                            var l = [];
                            Pi(e, function(e, t) {
                                t || -1 != j(l, e.history) || (bo(e.history, n),
                                l.push(e.history)),
                                go(e, n, null, Xi(e, n))
                            })
            ...
            function po(e, t) {
                if (0 != t && (e.first += t,
                e.sel = new Si(te(e.sel.ranges, function(e) {
                    return new Li(it(e.anchor.line + t, e.anchor.ch),it(e.head.line + t, e.head.ch))
                }),e.sel.primIndex),
                e.cm)) {
                ...
                if (t.to.line < e.first)
                    ...
                    e.cm ? function(e, t, r) {
                        var n = e.doc
                          ...
                          , s = !1
                          , a = o.line;
                        e.options.lineWrapping || (a = et(Ut(qe(n, o.line))),
                        n.iter(a, l.line + 1, function(e) {
                            if (e == i.maxLine)
                                return s = !0,
                                !0
                        })),
                        n.sel.contains(t.from, t.to) > -1 && Ce(e),
                        Fi(n, t, r, un(e)),
                        ...
                        function(e, t) {
                            ...
                            !(e.highlightFrontier < t - 10)) {
                                for (var r = e.first, n = t - 1; n > r; n--) {
                                    ...
                                    if (i && (!(i instanceof dt) || n + i.lookAhead < t)) {
                                        r = n + 1;
                                        break
                                    }
                                }
                        ...
                        t.full ? dn(e) : o.line != l.line || 1 != t.text.length || Hi(e.doc, t) ? dn(e, o.line, l.line + 1, u) : pn(e, o.line, "text");
                        var c = Se(e, "changes")
                          , h = Se(e, "change");
                        if (h || c) {
                            var f = {
                    ...
                    to(e, r, $),
                    e.cantEdit && lo(e, it(e.firstLine(), 0)) && (e.cantEdit = !1)
                }
            }
                ...
                for (var i = 0; i < e.length; ++i) {
                    ...
                    if (o.ranges) {
                        ...
                        for (var s = 0; s < o.ranges.length; s++)
                            mo(o.ranges[s].anchor, t, r, n),
                            mo(o.ranges[s].head, t, r, n)
                    } else {
            ...
            function wo(e, t, r, n) {
                var i = t
                  , o = t;
                return "number" == typeof t ? o = qe(e, ct(e, t)) : i = et(t),
                null == i ? null : (n(o, i) && e.cm && pn(e.cm, i, r),
                o)
            }
            function xo(e) {
                this.lines = e,
                        ...
                        if (e <= o) {
                            ...
                            i.lines && i.lines.length > 50) {
                                for (var l = i.lines.length % 25 + 25, s = l; s < i.lines.length; ) {
                                    var a = new xo(i.lines.slice(s, s += 25));
                                    i.height -= a.height,
            ...
            function Lo(e, t, r) {
                Yt(t) < (e.curOp && e.curOp.scrollTop || e.doc.scrollTop) && Wn(e, r)
            }
            So.prototype.clear = function() {
                ...
                if (null != n && t) {
                    ...
                    hr(e, "lineWidgetCleared", e, this, n))
                }
            }
            ,
            So.prototype.changed = function() {
                ...
                this.height = null;
                var i = Lr(this) - t;
                i && (jt(this.doc, n) || Qe(n, n.height + i),
                r && ei(r, function() {
                    r.curOp.forceUpdate = !0,
                    Lo(r, n, i),
                    hr(r, "lineWidgetChanged", r, e, et(n))
                }))
            }
            ,
            Le(So);
            ...
            function Mo(e, t, r, n, i) {
                ...
                o.collapsed) {
                    if (Gt(e, t.line, t, r, o) || t.line != r.line && Gt(e, r.line, t, r, o))
                ...
                if (e.iter(a, r.line + 1, function(n) {
                    u && o.collapsed && !u.options.lineWrapping && Ut(n) == u.display.maxLine && (s = !0),
                    o.collapsed && a != t.line && Qe(n, 0),
                    function(e, t, r) {
                        var n = r && window.WeakSet && (r.markedSpans || (r.markedSpans = new WeakSet));
                        n && e.markedSpans && n.has(e.markedSpans) ? e.markedSpans.push(t) : (e.markedSpans = e.markedSpans ? e.markedSpans.concat([t]) : [t],
                        n && n.add(e.markedSpans)),
                        t.marker.attachLine(e)
                    }(n, new Mt(o,a == t.line ? t.ch : null,a == r.line ? r.ch : null), e.cm && e.cm.curOp),
                    ++a
                }),
                o.collapsed && e.iter(t.line, r.line + 1, function(t) {
                    jt(e, t) && Qe(t, 0)
                }),
                o.clearOnEnter && me(o, "beforeCursorEnter", function() {
                    return o.clear()
                }),
                o.readOnly && (kt = !0,
            ...
            To.prototype.clear = function() {
                if (!this.explicitlyCleared) {
                    ...
                    Se(this, "clear")) {
                        var r = this.find();
                        r && hr(this, "clear", r.from, r.to)
                    }
                    for (var n = null, i = null, o = 0; o < this.lines.length; ++o) {
                        var l = this.lines[o]
                          , s = Nt(l.markedSpans, this);
                        e && !this.collapsed ? pn(e, et(l), "text") : e && (null != s.to && (i = et(l)),
                        null != s.from && (n = et(l))),
                        l.markedSpans = Ot(l.markedSpans, s),
                        null == s.from && this.collapsed && !jt(this.doc, l) && e && Qe(l, on(e.display))
                    }
                    if (e && this.collapsed && !e.options.lineWrapping)
                        for (var a = 0; a < this.lines.length; ++a) {
                            var u = Ut(this.lines[a])
                              , c = $t(u);
                            c > e.display.maxLineLength && (e.display.maxLine = u,
                    ...
                    e && no(e.doc)),
                    e && hr(e, "markerCleared", e, this, n, i),
                    t && _n(e),
            ...
            To.prototype.find = function(e, t) {
                ...
                for (var i = 0; i < this.lines.length; ++i) {
                    var o = this.lines[i]
                      , l = Nt(o.markedSpans, this);
                    if (null != l.from && (r = it(t ? o : et(o), l.from),
                    -1 == e))
                        return r;
                    if (null != l.to && (n = it(t ? o : et(o), l.to),
                    1 == e))
                        return n
                }
                return r && {
            ...
            To.prototype.changed = function() {
                ...
                t && n && ei(n, function() {
                    ...
                    !jt(r.doc, i) && null != r.height) {
                        var s = r.height;
                        r.height = null;
                        var a = Lr(r) - s;
                        a && Qe(i, i.height + a)
                    }
                    hr(n, "markerChanged", n, e)
                })
            }
            ,
            ...
            To.prototype.detachLine = function(e) {
                if (this.lines.splice(j(this.lines, e), 1),
            ...
            Le(No);
            var Do = 0
              , Wo = function(e, t, r, n, i) {
                if (!(this instanceof Wo))
                    return new Wo(e,t,r,n,i);
                null == r && (r = 0),
                Co.call(this, [new xo([new qt("",null)])]),
                this.first = r,
            ...
            Wo.prototype = ne(Co.prototype, {
                ...
                getLineHandleVisualStart: function(e) {
                    return "number" == typeof e && (e = qe(this, e)),
                    Ut(e)
                },
                lineCount: function() {
                    return this.size
                ...
                setCursor: ni(function(e, t, r) {
                    Ji(this, ht(this, "number" == typeof e ? it(e, t || 0) : e), null, r)
                }),
                setSelection: ni(function(e, t, r) {
                    Ji(this, ht(this, e), ht(this, t || e), r)
                }),
                extendSelection: ni(function(e, t, r) {
                    _i(this, ht(this, e), t && ht(this, t), r)
                }),
                extendSelections: ni(function(e, t) {
                    qi(this, ft(this, e), t)
                }),
                extendSelectionsBy: ni(function(e, t) {
                    var r = te(this.sel.ranges, e);
                    qi(this, ft(this, r), t)
                }),
                setSelections: ni(function(e, t, r) {
                    if (e.length) {
                        for (var n = [], i = 0; i < e.length; i++)
                            n[i] = new Li(ht(this, e[i].anchor),ht(this, e[i].head || e[i].anchor));
                        null == t && (t = Math.min(e.length - 1, this.sel.primIndex)),
                        eo(this, ki(this.cm, n, t), r)
                    }
                }),
                addSelection: ni(function(e, t, r) {
                    var n = this.sel.ranges.slice(0);
                    n.push(new Li(ht(this, e),ht(this, t || e))),
                    eo(this, ki(this.cm, n, n.length - 1), r)
                }),
                ...
                replaceSelections: ni(function(e, t, r) {
                    ...
                    for (var s = t && "end" != t && function(e, t, r) {
                        ...
                        co(this, n[a]);
                    s ? Qi(this, s) : this.cm && Hn(this.cm)
                }),
                undo: ni(function() {
                    fo(this, "undo")
                }),
                ...
                clearHistory: function() {
                    var e = this;
                    this.history = new zi(this.history),
                    Pi(this, function(t) {
                ...
                setHistory: function(e) {
                    var t = this.history = new zi(this.history);
                    t.done = Yi(e.done.slice(0), null, !0),
                    t.undone = Yi(e.undone.slice(0), null, !0)
                },
                setGutterMarker: ni(function(e, t, r) {
                    return wo(this, e, "gutter", function(e) {
                        var n = e.gutterMarkers || (e.gutterMarkers = {});
                        return n[t] = r,
                        !r && se(n) && (e.gutterMarkers = null),
                        !0
                    })
                }),
                clearGutter: ni(function(e) {
                    ...
                    this.iter(function(r) {
                        r.gutterMarkers && r.gutterMarkers[e] && wo(t, r, "gutter", function() {
                            return r.gutterMarkers[e] = null,
                            se(r.gutterMarkers) && (r.gutterMarkers = null),
                            !0
                        })
                    })
                }),
                ...
                addLineClass: ni(function(e, t, r) {
                ...
                removeLineClass: ni(function(e, t, r) {
                    return wo(this, e, "gutter" == t ? "gutter" : "class", function(e) {
                        var n = "text" == t ? "textClass" : "background" == t ? "bgClass" : "gutter" == t ? "gutterClass" : "wrapClass"
                          , i = e[n];
                        if (!i)
                ...
                addLineWidget: ni(function(e, t, r) {
                    return function(e, t, r, n) {
                        var i = new So(e,r,n)
                          , o = e.cm;
                        ...
                        wo(e, t, "widget", function(t) {
                            ...
                            if (null == i.insertAt ? r.push(i) : r.splice(Math.min(r.length, Math.max(0, i.insertAt)), 0, i),
                            i.line = t,
                            o && !jt(e, t)) {
                                var n = Yt(t) < e.scrollTop;
                                Qe(t, t.height + Lr(i)),
                                n && Wn(o, i.height),
                        ...
                        o && hr(o, "lineWidgetAdded", o, i, "number" == typeof t ? t : et(t)),
                        i
                    }(this, e, t, r)
                }),
                ...
                markText: function(e, t, r) {
                    return Mo(this, ht(this, e), ht(this, t), r, r && r.type || "range")
                },
                setBookmark: function(e, t) {
                    ...
                    return Mo(this, e = ht(this, e), e, r, "bookmark")
                },
                ...
                copy: function(e) {
                    var t = new Wo(Je(this, this.first, this.first + this.size),this.modeOption,this.first,this.lineSep,this.direction);
                ...
                linkedDoc: function(e) {
                    ...
                    var n = new Wo(Je(this, t, r),e.mode || this.modeOption,t,this.lineSep,this.direction);
                    ...
                    function(e, t) {
                        for (var r = 0; r < t.length; r++) {
                            var n = t[r]
                              ...
                              , l = e.clipPos(i.to);
                            if (ot(o, l)) {
                                var s = Mo(e, o, l, n.primary, n.primary.type);
                                n.markers.push(s),
                                s.parent = n
                            }
                        }
                ...
                unlinkDoc: function(e) {
                    ...
                    if (e.history == this.history) {
                        ...
                        e.history = new zi(null),
                        e.history.done = Yi(this.history.done, n),
                        e.history.undone = Yi(this.history.undone, n)
                    }
                },
                        ...
                        if (n && n.length && window.FileReader && window.File)
                            for (var i = n.length, o = Array(i), s = 0, a = function() {
                                ++s == i && ti(t, function() {
                                    ...
                                    co(t.doc, e),
                                    Qi(t.doc, Ti(ht(t.doc, r), ht(t.doc, Mi(e))))
                                })()
                            }, u = function(e, r) {
                                if (t.options.allowDropFileTypes && -1 == j(t.options.allowDropFileTypes, e.type))
                                    ...
                                    n.onload = function() {
                                        var e = n.result;
                                        /[\x00-\x08\x0e-\x1f]{2}/.test(e) ? a() : (o[r] = e,
                                        a())
                                    }
                                    ,
                                    n.readAsText(e)
                            ...
                            try {
                                ...
                                if (h) {
                                    var f;
                                    if (t.state.draggingText && !t.state.draggingText.copy && (f = t.listSelections()),
                                    to(t.doc, Ti(r, r)),
                                    f)
                                        for (var d = 0; d < f.length; ++d)
                                            vo(t.doc, "", f[d].anchor, f[d].head, "drag");
            ...
            for (var Bo = {
                ...
                Bo[Go + 48] = Bo[Go + 96] = String(Go);
            for (var Uo = 65; Uo <= 90; Uo++)
                Bo[Uo] = String.fromCharCode(Uo);
            for (var Vo = 1; Vo <= 12; Vo++)
                Bo[Vo + 111] = Bo[Vo + 63235] = "F" + Vo;
            var Ko = {};
            function jo(e) {
            ...
            function Xo(e) {
                ...
                for (var r in e)
                    if (e.hasOwnProperty(r)) {
                        ...
                        for (var i = te(r.split(" "), jo), o = 0; o < i.length; o++) {
                            var l = void 0
                              , s = void 0;
            ...
            function Yo(e, t, r, n) {
                var i = (t = Zo(t)).call ? t.call(e, n) : t[e];
                if (!1 === i)
                    return "nothing";
                if ("..." === i)
                    return "multi";
                ...
                if (t.fallthrough) {
                    if ("[object Array]" != Object.prototype.toString.call(t.fallthrough))
                        return Yo(e, t.fallthrough, r, n);
                    for (var o = 0; o < t.fallthrough.length; o++) {
                        var l = Yo(e, t.fallthrough[o], r, n);
                        if (l)
                            return l
                    }
                }
            ...
            function Jo(e, t) {
                for (var r = e.doc.sel.ranges, n = [], i = 0; i < r.length; i++) {
                    for (var o = t(r[i]); n.length && ot(o.from, ee(n).to) <= 0; ) {
                        var l = n.pop();
                ...
                ei(e, function() {
                    for (var t = n.length - 1; t >= 0; t--)
                        vo(e.doc, "", n[t].from, n[t].to, "+delete");
                    Hn(e)
                })
            }
            function Qo(e, t, r) {
                var n = ce(e.text, t + r, r);
            ...
            function tl(e, t, r, n, i) {
                if (e) {
                    ...
                    var o = ge(r, t.doc.direction);
                    if (o) {
                        var l, s = i < 0 ? ee(o) : o[0], a = i < 0 == (1 == s.level), u = a ? "after" : "before";
                        if (s.level > 0 || "rtl" == t.doc.direction) {
                            var c = Pr(t, r);
                            l = i < 0 ? r.text.length - 1 : 0;
                            var h = Er(t, c, l).top;
                            l = he(function(e) {
                                return Er(t, c, e).top == h
                    ...
                    return ei(e, function() {
                        for (var t = e.listSelections(), r = [], n = 0; n < t.length; n++)
                            if (t[n].empty()) {
                                ...
                                if (o)
                                    if (i.ch == o.length && (i = new it(i.line,i.ch - 1)),
                                    i.ch > 0)
                                        i = new it(i.line,i.ch + 1),
                                        e.replaceRange(o.charAt(i.ch - 1) + o.charAt(i.ch - 2), it(i.line, i.ch - 2), i, "+transpose");
                                    else if (i.line > e.doc.first) {
                                        var l = qe(e.doc, i.line - 1).text;
                                        l && (i = new it(i.line,1),
                                        e.replaceRange(o.charAt(0) + e.doc.lineSeparator() + l.charAt(l.length - 1), it(i.line - 1, l.length - 1), i, "+transpose"))
                                    }
                                r.push(new Li(i,i))
                            }
                        e.setSelections(r)
            ...
            function sl(e, t, r, n) {
                ...
                if (i) {
                    if ($o(t))
                        return "handled";
                    if (/\'$/.test(t) ? e.state.keySeq = null : ll.set(50, function() {
            ...
            function al(e, t, r, n) {
                ...
                "handled" == i && hr(e, "keyHandled", e, t, r),
                "handled" != i && "multi" != i || (ke(r),
                Sn(e)),
                !!i
            }
            function ul(e, t) {
                var r = qo(t, !0);
                return !!r && (t.shiftKey && !e.state.keySeq ? sl(e, "Shift-" + r, t, function(t) {
                    return ol(e, t, !0)
                }) || sl(e, r, t, function(t) {
            ...
            function hl(e) {
                var t = this;
                if ((!e.target || e.target == t.display.input.getField()) && (t.curOp.focus = H(z(t)),
                !xe(t, e))) {
                    ...
                    var i = ul(t, e);
                    f && (cl = i ? n : null,
                    !i && 88 == n && !ze && (b ? e.metaKey : e.ctrlKey) && t.replaceSelection("", null, "cut")),
                    ...
                    18 != n || /\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) || function(e) {
                        ...
                        function r(e) {
                            18 != e.keyCode && e.altKey || (M(t, "CodeMirror-crosshair"),
                            be(document, "keyup", r),
                            be(document, "mouseover", r))
                        }
            ...
            function dl(e) {
                var t = this;
                if ((!e.target || e.target == t.display.input.getField()) && !(kr(t.display, e) || xe(t, e) || e.ctrlKey && !e.altKey || b && e.metaKey)) {
                    var r = e.keyCode
                      , n = e.charCode;
                    if (f && r == cl)
                        return cl = null,
                        void ke(e);
                    if (!f || e.which && !(e.which < 10) || !ul(t, e)) {
                        var i = String.fromCharCode(null == n ? r : n);
                        "\b" != i && (function(e, t, r) {
                            return sl(e, "'" + r + "'", t, function(t) {
                                return ol(e, t, !0)
                            })
            ...
            function ml(e) {
                var t = this
                  , r = t.display;
                if (!(xe(t, e) || r.activeTouch && r.input.supportsTouch()))
                    if (r.input.ensurePolled(),
                    r.shift = e.shiftKey,
                    kr(r, e))
                        a || (r.scroller.draggable = !1,
                        setTimeout(function() {
                        ...
                        var n = hn(t, e)
                          ...
                          , o = n ? function(e, t) {
                            var r = +new Date;
                            return gl && gl.compare(r, e, t) ? (pl = gl = null,
                            "triple") : pl && pl.compare(r, e, t) ? (gl = new vl(r,e,t),
                            pl = null,
                            "double") : (pl = new vl(r,e,t),
                            gl = null,
                            "single")
                        }(n, i) : "single";
                        B(t).focus(),
                        ...
                        n && function(e, t, r, n, i) {
                            ...
                            sl(e, _o(o = (1 == t ? "Left" : 2 == t ? "Middle" : "Right") + o, i), i, function(t) {
                                if ("string" == typeof t && (t = rl[t]),
                                !t)
                                    return !1;
                                var n = !1;
                            ...
                            l ? setTimeout(G(Ln, e), 0) : e.curOp.focus = H(z(e));
                            ...
                            e.options.dragDrop && He && !e.isReadOnly() && "single" == r && (i = u.contains(t)) > -1 && (ot((i = u.ranges[i]).from(), t) < 0 || t.xRel > 0) && (ot(i.to(), t) > 0 || t.xRel < 0) ? function(e, t, r, n) {
                                var i = e.display
                                  , o = !1
                                  , u = ti(e, function(t) {
                                    a && (i.scroller.draggable = !1),
                                    e.state.draggingText = !1,
                                    e.state.delayingBlurEvent && (e.hasFocus() ? e.state.delayingBlurEvent = !1 : kn(e)),
                                    be(i.wrapper.ownerDocument, "mouseup", u),
                                    be(i.wrapper.ownerDocument, "mousemove", c),
                                    be(i.scroller, "dragstart", h),
                                    be(i.scroller, "drop", u),
                                    o || (ke(t),
                                    n.addNew || _i(e.doc, r, null, null, n.extend),
                                    a && !d || l && 9 == s ? setTimeout(function() {
                                ...
                                u.copy = !n.moveOnDrag,
                                me(i.wrapper.ownerDocument, "mouseup", u),
                                me(i.wrapper.ownerDocument, "mousemove", c),
                                me(i.scroller, "dragstart", h),
                                me(i.scroller, "drop", u),
                                e.state.delayingBlurEvent = !0,
                                setTimeout(function() {
                                ...
                                var i = e.display
                                  , o = e.doc;
                                ke(t);
                                var s, a, u = o.sel, c = u.ranges;
                                if (n.addNew && !n.extend ? (a = o.sel.contains(r),
                                s = a > -1 ? c[a] : new Li(r,r)) : (s = o.sel.primary(),
                                a = o.sel.primIndex),
                                "rectangle" == n.unit)
                                    n.addNew || (s = new Li(r,r)),
                                    r = hn(e, t, !0, !0),
                                    a = -1;
                                else {
                                    var h = yl(e, r, n.unit);
                                    s = n.extend ? $i(s, h.anchor, h.head, n.extend) : h
                                }
                                n.addNew ? -1 == a ? (a = c.length,
                                eo(o, ki(e, c.concat([s]), a), {
                                    scroll: !1,
                                    origin: "*mouse"
                                })) : c.length > 1 && c[a].empty() && "char" == n.unit && !n.extend ? (eo(o, ki(e, c.slice(0, a).concat(c.slice(a + 1)), 0), {
                                    scroll: !1,
                                    origin: "*mouse"
                                }),
                                u = o.sel) : Zi(o, a, s, _) : (a = 0,
                                eo(o, new Si([s],0), _),
                                u = o.sel);
                                var f = r;
                                function d(t) {
                                    if (0 != ot(f, t))
                                        if (f = t,
                                        "rectangle" == n.unit) {
                                            for (var i = [], l = e.options.tabSize, c = V(qe(o, r.line).text, r.ch, l), h = V(qe(o, t.line).text, t.ch, l), d = Math.min(c, h), p = Math.max(c, h), g = Math.min(r.line, t.line), v = Math.min(e.lastLine(), Math.max(r.line, t.line)); g <= v; g++) {
                                                var m = qe(o, g).text
                                                  , y = Z(m, d, l);
                                                d == p ? i.push(new Li(it(g, y),it(g, y))) : m.length > y && i.push(new Li(it(g, y),it(g, Z(m, p, l))))
                                            }
                                            i.length || i.push(new Li(r,r)),
                                            eo(o, ki(e, u.ranges.slice(0, a).concat(i), a), {
                                                origin: "*mouse",
                                                scroll: !1
                                            }),
                                            e.scrollIntoView(t)
                                        } else {
                                            var b, w = s, x = yl(e, t, n.unit), C = w.anchor;
                                            ot(x.anchor, C) > 0 ? (b = x.head,
                                            C = ut(w.from(), x.anchor)) : (b = x.anchor,
                                            C = at(w.to(), x.head));
                                            ...
                                            S[a] = function(e, t) {
                                                var r = t.anchor
                                                  , n = t.head
                                                  , i = qe(e.doc, r.line);
                                                if (0 == ot(r, n) && r.sticky == n.sticky)
                                                    return t;
                                                var o = ge(i);
                                                if (!o)
                                                    return t;
                                                var l = de(o, r.ch, r.sticky)
                                                  , s = o[l];
                                                ...
                                                var f = o[u + (a ? -1 : 0)]
                                                  ...
                                                  , p = d ? f.from : f.to
                                                  , g = d ? "after" : "before";
                                                return r.ch == p && r.sticky == g ? t : new Li(new it(r.line,p,g),n)
                                            }(e, new Li(ht(o, C),b)),
                                            eo(o, ki(e, S, a), _)
                                        }
                                }
                                ...
                                function v(t) {
                                    ...
                                    t && (ke(t),
                                    i.input.focus()),
                                    be(i.wrapper.ownerDocument, "mousemove", m),
                                    be(i.wrapper.ownerDocument, "mouseup", y),
                                    o.history.lastSelOrigin = null
                                }
                                var m = ti(e, function(t) {
                                    0 !== t.buttons && Ae(t) ? function t(r) {
                                        var l = ++g
                                          , s = hn(e, r, !0, "rectangle" == n.unit);
                                        if (s)
                                            if (0 != ot(s, f)) {
                                                e.curOp.focus = H(z(e)),
                                                d(s);
                                                var a = An(i, o);
                                                (s.line >= a.to || s.line < a.from) && setTimeout(ti(e, function() {
                                                    g == l && t(r)
                                                }), 150)
                                            } else {
                                                var u = r.clientY < p.top ? -20 : r.clientY > p.bottom ? 20 : 0;
                                                u && setTimeout(ti(e, function() {
                                                    g == l && (i.scroller.scrollTop += u,
                                                    t(r))
                                                }), 50)
                                            }
                                    }(t) : v(t)
                                ...
                                me(i.wrapper.ownerDocument, "mousemove", m),
                                me(i.wrapper.ownerDocument, "mouseup", y)
                            }(e, n, t, o)
                        }(t, n, o, e) : Oe(e) == r.scroller && ke(e) : 2 == i ? (n && _i(t.doc, n),
                        setTimeout(function() {
                            return r.input.focus()
                        }, 20)) : 3 == i && (L ? t.display.input.onContextMenu(e) : kn(t)))
                    }
            }
            function yl(e, t, r) {
                if ("char" == r)
                ...
                if ("line" == r)
                    return new Li(it(t.line, 0),ht(e.doc, it(t.line + 1, 0)));
                var n = r(e, t);
                return new Li(n.from,n.to)
            }
            function bl(e, t, r, n) {
                var i, o;
                if (t.touches)
                ...
                for (var a = 0; a < e.display.gutterSpecs.length; ++a) {
                    ...
                    if (u && u.getBoundingClientRect().right >= i) {
                        ...
                        return we(e, r, e, c, h.className, t),
                        Me(t)
                    }
                }
            }
            function wl(e, t) {
                return bl(e, t, "gutterClick", !0)
            }
            function xl(e, t) {
                kr(e.display, t) || function(e, t) {
                    return !!Se(e, "gutterContextMenu") && bl(e, t, "gutterContextMenu", !1)
                }(e, t) || xe(e, t, "contextmenu") || L || e.display.input.onContextMenu(t)
            }
            function Cl(e) {
            ...
            vl.prototype.compare = function(e, t, r) {
                return this.time + 400 > e && 0 == ot(t, this.pos) && r == this.button
            }
            ;
            var Sl = {
                toString: function() {
            ...
            function Ml(e) {
                e.options.lineWrapping ? (F(e.display.wrapper, "CodeMirror-wrap"),
                e.display.sizer.style.minWidth = "",
                e.display.sizerWidth = null) : (M(e.display.wrapper, "CodeMirror-wrap"),
                _t(e)),
                cn(e),
                dn(e),
                Vr(e),
            ...
            function Nl(e, t) {
                ...
                U(Ll, t, !1);
                var n = t.value;
                "string" == typeof n ? n = new Wo(n,t.mode,null,t.lineSeparator,t.direction) : t.mode && (n.modeOption = t.mode),
                this.doc = n;
                ...
                l && s < 11 && setTimeout(function() {
                    return r.display.input.reset(!0)
                }, 20),
                function(e) {
                    var t = e.display;
                    me(t.scroller, "mousedown", ti(e, ml)),
                    me(t.scroller, "dblclick", l && s < 11 ? ti(e, function(t) {
                        if (!xe(e, t)) {
                            var r = hn(e, t);
                            if (r && !wl(e, t) && !kr(e.display, t)) {
                                ke(t);
                    ...
                    me(t.scroller, "contextmenu", function(t) {
                        return xl(e, t)
                    }),
                    me(t.input.getField(), "contextmenu", function(r) {
                        t.scroller.contains(r.target) || xl(e, r)
                    });
                    var r, n = {
                        end: 0
                    };
                    ...
                    me(t.scroller, "touchstart", function(i) {
                        if (!xe(e, i) && !function(e) {
                    ...
                    me(t.scroller, "touchmove", function() {
                        t.activeTouch && (t.activeTouch.moved = !0)
                    }),
                    me(t.scroller, "touchend", function(r) {
                        var n = t.activeTouch;
                        if (n && !kr(t, r) && null != n.left && !n.moved && new Date - n.start < 300) {
                            var l, s = e.coordsChar(t.activeTouch, "page");
                            l = !n.prev || o(n, n.prev) ? new Li(s,s) : !n.prev.prev || o(n, n.prev.prev) ? e.findWordAt(s) : new Li(it(s.line, 0),ht(e.doc, it(s.line + 1, 0))),
                    ...
                    me(t.scroller, "touchcancel", i),
                    me(t.scroller, "scroll", function() {
                        t.scroller.clientHeight && (Rn(e, t.scroller.scrollTop),
                        In(e, t.scroller.scrollLeft, !0),
                        we(e, "scroll", e))
                    }),
                    ...
                    t.dragFunctions = {
                        ...
                        start: function(t) {
                            return function(e, t) {
                                if (l && (!e.state.draggingText || +new Date - Ho < 100))
                                    Ne(t);
                                else if (!xe(e, t) && !kr(e.display, t) && (t.dataTransfer.setData("Text", e.getSelection()),
                    ...
                    me(a, "keyup", function(t) {
                        return fl.call(e, t)
                    }),
                    me(a, "keydown", ti(e, hl)),
                    me(a, "keypress", ti(e, dl)),
                    me(a, "focus", function(t) {
                        return Tn(e, t)
                    }),
                    me(a, "blur", function(t) {
                        return Mn(e, t)
                    })
                }(this),
                zo(),
                ...
                Ei(this, n),
                t.autofocus && !y || this.hasFocus() ? setTimeout(function() {
                    r.hasFocus() && !r.state.focused && Tn(r)
                }, 20) : Mn(this),
                kl)
                    kl.hasOwnProperty(u) && kl[u](this, t[u], Sl);
                di(this),
                t.finishInit && t.finishInit(this);
                for (var c = 0; c < Ol.length; ++c)
                    Ol[c](this);
                _n(this),
                a && t.lineWrapping && "optimizelegibility" == getComputedStyle(o.lineDiv).textRendering && (o.lineDiv.style.textRendering = "auto")
            }
            Nl.defaults = Ll,
            Nl.optionHandlers = kl;
            var Ol = [];
            function Al(e, t, r, n) {
                var i, o = e.doc;
                null == r && (r = "add"),
                "smart" == r && (o.mode.indent ? i = mt(e, t).state : r = "prev");
                ...
                if (n || /\S/.test(s.text)) {
                    if ("smart" == r && ((u = o.mode.indent(i, s.text.slice(c.length), s.text)) == Y || u > 150)) {
                        if (!n)
                            return;
                        r = "prev"
                    }
                    ...
                    u = 0,
                    r = "not";
                "prev" == r ? u = t > o.first ? V(qe(o, t - 1).text, null, l) : 0 : "add" == r ? u = a + e.options.indentUnit : "subtract" == r ? u = a - e.options.indentUnit : "number" == typeof r && (u = a + r),
                u = Math.max(0, u);
                var h = ""
                  , f = 0;
                ...
                if (f < u && (h += Q(u - f)),
                h != c)
                    return vo(o, h, it(t, 0), it(t, c.length), "+input"),
                    s.stateAfter = null,
                    !0;
            ...
            function Hl(e, t, r, n, i) {
                ...
                if (s && n.ranges.length > 1)
                    if (Dl && Dl.text.join("\n") == t) {
                        ...
                        a.length == n.ranges.length && e.options.pasteLinesPerSelection && (u = te(a, function(e) {
                            return [e]
                        }));
                for (var h = e.curOp.updateInput, f = n.ranges.length - 1; f >= 0; f--) {
                    var d = n.ranges[f]
                      , p = d.from()
                      , g = d.to();
                    d.empty() && (r && r > 0 ? p = it(p.line, p.ch - r) : e.state.overwrite && !s ? g = it(g.line, Math.min(qe(o, g.line).text.length, g.ch + ee(a).length)) : s && Dl && Dl.lineWise && Dl.text.join("\n") == a.join("\n") && (p = g = it(p.line, 0)));
                    var v = {
                        from: p,
                        to: g,
            ...
            function Fl(e, t) {
                ...
                if (r)
                    ...
                    t.isReadOnly() || t.options.disableInput || !t.hasFocus() || ei(t, function() {
                    ...
                    for (var r = e.doc.sel, n = r.ranges.length - 1; n >= 0; n--) {
                        ...
                        if (!(i.head.ch > 100 || n && r.ranges[n - 1].head.line == i.head.line)) {
                            ...
                            if (o.electricChars) {
                                ...
                                o.electricInput && o.electricInput.test(qe(e.doc, i.head.line).text.slice(0, i.head.ch)) && (l = Al(e, i.head.line, "smart"));
                            l && hr(e, "electricInput", e, i.head.line)
                        }
                    }
            }
            function El(e) {
            ...
            function zl() {
                ...
                return a ? e.style.width = "1000px" : e.setAttribute("wrap", "off"),
            ...
            function Il(e, t, r, n, i) {
                ...
                function u(o) {
                    ...
                    if ("codepoint" == n) {
                        ...
                        if (isNaN(u))
                            ...
                            var c = r > 0 ? u >= 55296 && u < 56320 : u >= 56320 && u < 57343;
                            l = new it(t.line,Math.max(0, Math.min(s.text.length, t.ch + r * (c ? 2 : 1))),-r)
                        }
                    } else
                        l = i ? function(e, t, r, n) {
                            ...
                            r.sticky = "after");
                            var o = de(i, r.ch, r.sticky)
                              , l = i[o];
                            if ("ltr" == e.doc.direction && l.level % 2 == 0 && (n > 0 ? l.to > r.ch : l.from < r.ch))
                                return el(t, r, n);
                            var s, a = function(e, r) {
                                return Qo(t, e instanceof it ? e.ch : e, r)
                            }, u = function(r) {
                                return e.options.lineWrapping ? (s = s || Pr(e, t),
                                tn(e, t, s, r)) : {
                                    begin: 0,
                                    end: t.text.length
                                }
                            ...
                            var p = function(e, t, n) {
                                for (var o = function(e, t) {
                                    return t ? new it(r.line,a(e, 1),"before") : new it(r.line,e,"after")
                                }; e >= 0 && e < i.length; e += t) {
                                    var l = i[e]
                                      , s = t > 0 == (1 != l.level)
                    ...
                    if (null == l) {
                        if (o || !function() {
                            var r = t.line + a;
                            return !(r < e.first || r >= e.first + e.size) && (t = new it(r,t.ch,t.sticky),
                            s = qe(e, r))
                        }())
                            return !1;
                        t = tl(i, e.cm, s, t.line, a)
                    } else
                        t = l;
                    return !0
                }
                if ("char" == n || "codepoint" == n)
                    u();
                else if ("column" == n)
                    u(!0);
                ...
                var v = lo(e, t, o, l, !0);
                return lt(o, v) && (v.hitSide = !0),
                v
            }
            function Bl(e, t, r, n) {
                var i, o, l = e.doc, s = t.left;
                if ("page" == n) {
                    var a = Math.min(e.display.wrapper.clientHeight, B(e).innerHeight || l(e).documentElement.clientHeight)
                      , u = Math.max(a - .5 * on(e.display), 3);
                    i = (r > 0 ? t.bottom : t.top) + r * u
                } else
                    "line" == n && (i = r > 0 ? t.bottom + 3 : t.top - 3);
                for (; (o = Qr(e, s, i)).outside; ) {
            ...
            function Ul(e, t) {
                ...
                var n = qe(e.doc, t.line)
                  , i = Wr(r, n, t.line)
                  , o = ge(n, e.doc.direction)
                  , l = "left";
                if (o) {
                    var s = de(o, t.ch);
                    l = s % 2 ? "right" : "left"
                }
                var a = Ir(i.map, t.ch, l);
            ...
            function Kl(e, t, r) {
                ...
                if (t == e.display.lineDiv) {
                    if (!(n = e.display.lineDiv.childNodes[r]))
                        return Vl(e.clipPos(it(e.display.viewTo - 1)), !0);
                    t = null,
                    r = 0
                } else
            ...
            function jl(e, t, r) {
                var n = e.text.firstChild
                  , i = !1;
                if (!t || !W(n, t))
                    return Vl(it(et(e.line), 0), !0);
                if (t == n && (i = !0,
                t = n.childNodes[r],
                r = 0,
                !t)) {
                    var o = e.rest ? ee(e.rest) : e.line;
                    return Vl(it(et(o), o.text.length), i)
                }
            ...
            Gl.prototype.init = function(e) {
                ...
                function l(e) {
                    if (o(e) && !xe(n, e)) {
                        ...
                        if (e.clipboardData) {
                            ...
                            var l = Dl.text.join("\n");
                            if (e.clipboardData.setData("Text", l),
                ...
                i.contentEditable = !0,
                Rl(i, n.options.spellcheck, n.options.autocorrect, n.options.autocapitalize),
                me(i, "paste", function(e) {
                    !o(e) || xe(n, e) || Fl(e, n) || s <= 11 && setTimeout(ti(n, function() {
                        return t.updateFromDOM()
                    }), 20)
                }),
                me(i, "compositionstart", function(e) {
                    t.composing = {
                        data: e.data,
                        done: !1
                    }
                }),
                me(i, "compositionupdate", function(e) {
                    t.composing || (t.composing = {
                        data: e.data,
                        done: !1
                    })
                }),
                me(i, "compositionend", function(e) {
                    t.composing && (e.data != t.composing.data && t.readFromDOMSoon(),
                    t.composing.done = !0)
                }),
                me(i, "touchstart", function() {
            ...
            Gl.prototype.prepareSelection = function() {
                var e = bn(this.cm, !1);
                return e.focus = H(I(this.div)) == this.div,
                e
            }
            ,
            ...
            Gl.prototype.showPrimarySelection = function() {
                ...
                if (t.display.viewTo == t.display.viewFrom || i.line >= t.display.viewTo || o.line < t.display.viewFrom)
                    ...
                    if (!l || l.bad || !s || s.bad || 0 != ot(ut(l, s), i) || 0 != ot(at(l, s), o)) {
                        ...
                        if (u && c) {
                            ...
                            d && (!r && t.state.focused ? (e.collapse(u.node, u.offset),
            ...
            Gl.prototype.focus = function() {
                "nocursor" != this.cm.options.readOnly && (this.selectionInEditor() && H(I(this.div)) == this.div || this.showSelection(this.prepareSelection(), !0),
                this.div.focus())
            }
            ,
            ...
            Gl.prototype.pollSelection = function() {
                if (null == this.readDOMTimeout && !this.gracePeriod && this.selectionChanged()) {
                    var e = this.getSelection()
                      , t = this.cm;
                    if (m && c && this.cm.display.gutterSpecs.length && function(e) {
            ...
            Gl.prototype.pollContent = function() {
                ...
                if (0 == l.ch && l.line > n.firstLine() && (l = it(l.line - 1, qe(n.doc, l.line - 1).length)),
                s.ch == qe(n.doc, s.line).text.length && s.line < n.lastLine() && (s = it(s.line + 1, 0)),
                l.line < i.viewFrom || s.line > i.viewTo - 1)
                    return !1;
                l.line == i.viewFrom || 0 == (e = fn(n, l.line)) ? (t = et(i.view[0].line),
                r = i.view[0].node) : (t = et(i.view[e].line),
                r = i.view[e - 1].node.nextSibling);
                var a, u, c = fn(n, s.line);
                if (c == i.view.length - 1 ? (a = i.viewTo - 1,
                u = i.lineDiv.lastChild) : (a = et(i.view[c + 1].line) - 1,
                ...
                for (var h = n.doc.splitLines(function(e, t, r, n, i) {
                    ...
                    function h(t) {
                        if (1 == t.nodeType) {
                            ...
                            if (f) {
                                var d = e.findMarks(it(n, 0), it(i + 1, 0), (v = +f,
                                function(e) {
                                    return e.id == v
                                }
                                ));
                                return void (d.length && (o = d[0].find(0)) && c(Ze(e.doc, o.from, o.to).join(s)))
                            }
                            ...
                            for (var g = 0; g < t.childNodes.length; g++)
                                h(t.childNodes[g]);
                            /^(pre|p)$/i.test(t.nodeName) && (a = !0),
                            p && (l = !0)
                        } else
                            3 == t.nodeType && c(t.nodeValue.replace(/\u200b/g, "").replace(/\u00a0/g, " "));
                        var v
                    }
                    for (; h(t),
                    t != r; )
                        ...
                        a = !1;
                    return o
                }(n, r, u, t, a)), f = Ze(n.doc, it(t, 0), it(a, qe(n.doc, a).text.length)); h.length > 1 && f.length > 1; )
                    if (ee(h) == ee(f))
                        h.pop(),
                        f.pop(),
                        a--;
                ...
                for (var d = 0, p = 0, g = h[0], v = f[0], m = Math.min(g.length, v.length); d < m && g.charCodeAt(d) == v.charCodeAt(d); )
                    ++d;
                for (var y = ee(h), b = ee(f), w = Math.min(y.length - (1 == h.length ? d : 0), b.length - (1 == f.length ? d : 0)); p < w && y.charCodeAt(y.length - p - 1) == b.charCodeAt(b.length - p - 1); )
                    ++p;
                ...
                var x = it(t, d)
                  , C = it(a, f.length ? ee(f).length - p : 0);
                return h.length > 1 || h[0] || ot(x, C) ? (vo(n.doc, h, x, C, "+input"),
                !0) : void 0
            }
            ,
            ...
            Gl.prototype.onKeyPress = function(e) {
                ...
                this.cm.isReadOnly() || ti(this.cm, Hl)(this.cm, String.fromCharCode(null == e.charCode ? e.keyCode : e.charCode), 0))
            }
            ,
            ...
            ,
            Gl.prototype.onContextMenu = function() {}
            ,
            Gl.prototype.resetPosition = function() {}
            ,
            Gl.prototype.needsContentAttribute = !0;
            var Xl = function(e) {
                this.cm = e,
                this.prevInput = "",
                this.pollingFast = !1,
            ...
            Xl.prototype.init = function(e) {
                ...
                function o(e) {
                    if (!xe(n, e)) {
                        if (n.somethingSelected())
                            ...
                            "cut" == e.type ? n.setSelections(t.ranges, null, $) : (r.prevInput = "",
                            i.value = t.text.join("\n"),
                            E(i))
                        }
                ...
                me(i, "paste", function(e) {
                    xe(n, e) || Fl(e, n) || (n.state.pasteIncoming = +new Date,
                    r.fastPoll())
                }),
                me(i, "cut", o),
                me(i, "copy", o),
                me(e.scroller, "paste", function(t) {
                    if (!kr(e, t) && !xe(n, t)) {
                        if (!i.dispatchEvent)
                            return n.state.pasteIncoming = +new Date,
                            void r.focus();
                ...
                me(e.lineSpace, "selectstart", function(t) {
                    kr(e, t) || ke(t)
                }),
                me(i, "compositionstart", function() {
            ...
            Xl.prototype.createField = function(e) {
                ...
                Rl(this.textarea, t.spellcheck, t.autocorrect, t.autocapitalize)
            }
            ,
            ...
            Xl.prototype.showSelection = function(e) {
                var t = this.cm
                  , r = t.display;
                O(r.cursorDiv, e.cursors),
                O(r.selectionDiv, e.selection),
            ...
            Xl.prototype.focus = function() {
                if ("nocursor" != this.cm.options.readOnly && (!y || H(I(this.textarea)) != this.textarea))
                    try {
                        this.textarea.focus()
                    } catch (e) {}
            }
            ...
            Xl.prototype.poll = function() {
                var e = this
                  ...
                  , r = this.textarea
                  , n = this.prevInput;
                if (this.contextMenuPending || this.resetting || !t.state.focused || Re(r) && !n && !this.composing || t.isReadOnly() || t.options.disableInput || t.state.keySeq)
                    return !1;
                var i = r.value;
                if (i == n && !t.somethingSelected())
                    return !1;
                if (l && s >= 9 && this.hasSelection === i || b && /[\uf700-\uf7ff]/.test(i))
                ...
                for (var a = 0, u = Math.min(n.length, i.length); a < u && n.charCodeAt(a) == i.charCodeAt(a); )
                    ++a;
                return ei(t, function() {
                    Hl(t, i.slice(a), n.length - a, null, e.composing ? "*compose" : null),
            ...
            Xl.prototype.onContextMenu = function(e) {
                ...
                if (o && !f) {
                    ...
                    c && -1 == r.doc.sel.contains(o) && ti(r, eo)(r.doc, Ti(o), $);
                    var h, d = i.style.cssText, p = t.wrapper.style.cssText, g = t.wrapper.offsetParent.getBoundingClientRect();
                    ...
                    a && (h = i.ownerDocument.defaultView.scrollY),
                    n.input.focus(),
                    a && i.ownerDocument.defaultView.scrollTo(null, h),
                    n.input.reset(),
                ...
                function y() {
                    if (t.contextMenuPending == y && (t.contextMenuPending = !1,
                    ...
                    null != i.selectionStart)) {
                        ...
                        var e = 0
                          , o = function() {
                            n.selForContextMenu == r.doc.sel && 0 == i.selectionStart && i.selectionEnd > 0 && "\u200b" == t.prevInput ? ti(r, ao)(r) : e++ < 10 ? n.detectingSelectAll = setTimeout(o, 500) : (n.selForContextMenu = null,
                            n.input.reset())
                        };
            ...
            ,
            Xl.prototype.setUneditable = function() {}
            ,
            Xl.prototype.needsContentAttribute = !1,
            function(e) {
                var t = e.optionHandlers;
                function r(r, n, i, o) {
                    e.defaults[r] = n,
                    i && (t[r] = o ? function(e, t, r) {
                        r != Sl && i(e, t, r)
                    }
                    : i)
                }
                ...
                r("lineSeparator", null, function(e, t) {
                    ...
                    t) {
                        ...
                        for (var i = r.length - 1; i >= 0; i--)
                            vo(e.doc, t, r[i], it(r[i].line, r[i].ch + t.length))
                    }
                }),
                ...
                r("specialCharPlaceholder", rr, function(e) {
                    return e.refresh()
                }, !0),
                r("electricChars", !0),
                r("inputStyle", y ? "contenteditable" : "textarea", function() {
                    throw new Error("inputStyle can not (yet) be changed in a running editor")
                }, !0),
                r("spellcheck", !1, function(e, t) {
                    return e.getInputField().spellcheck = t
                }, !0),
                r("autocorrect", !1, function(e, t) {
                    return e.getInputField().autocorrect = t
                }, !0),
                r("autocapitalize", !1, function(e, t) {
                ...
                r("lineWrapping", !1, Ml, !0),
                r("gutters", [], function(e, t) {
                    e.display.gutterSpecs = pi(t, e.options.lineNumbers),
                    vi(e)
                }, !0),
                r("fixedGutter", !0, function(e, t) {
                    e.display.gutters.style.left = t ? an(e.display) + "px" : "0",
                    e.refresh()
                }, !0),
                r("coverGutterNextToScrollbar", !1, function(e) {
                    return Vn(e)
                }, !0),
                ...
                r("lineNumbers", !1, function(e, t) {
                    e.display.gutterSpecs = pi(e.options.gutters, t),
                    vi(e)
                }, !0),
                ...
                r("workTime", 100),
                r("workDelay", 100),
                r("flattenSpans", !0, Wi, !0),
                r("addModeClass", !1, Wi, !0),
                r("pollInterval", 100),
                ...
                e.prototype = {
                    ...
                    setOption: function(e, r) {
                        var n = this.options
                          , i = n[e];
                        n[e] == r && "mode" != e || (n[e] = r,
                        t.hasOwnProperty(e) && ti(this, t[e])(this, r, i),
                        we(this, "optionChange", this, e))
                    },
                    ...
                    indentSelection: ri(function(e) {
                        for (var t = this.doc.sel.ranges, r = -1, n = 0; n < t.length; n++) {
                            ...
                            if (i.empty())
                                ...
                                0 == o.ch && t.length == u.length && u[n].from().ch > 0 && Zi(this.doc, n, new Li(o,u[n].to()), $)
                            }
                        }
                    }),
                    ...
                    getTokenTypeAt: function(e) {
                        e = ht(this.doc, e);
                        var t, r = vt(this, qe(this.doc, e.line)), n = 0, i = (r.length - 1) / 2, o = e.ch;
                        if (0 == o)
                            t = r[2];
                        else
                            for (; ; ) {
                    ...
                    getHelpers: function(e, t) {
                        ...
                        for (var a = 0; a < i._global.length; a++) {
                            var u = i._global[a];
                            u.pred(o, this) && -1 == j(n, u.val) && n.push(u.val)
                        }
                        return n
                    },
                    getStateAfter: function(e, t) {
                        var r = this.doc;
                        return mt(this, (e = ct(r, null == e ? r.first + r.size - 1 : e)) + 1, t).state
                    },
                    cursorCoords: function(e, t) {
                        var r = this.doc.sel.primary();
                        return qr(this, null == e ? r.head : "object" == typeof e ? ht(this.doc, e) : e ? r.from() : r.to(), t || "page")
                    },
                    charCoords: function(e, t) {
                        return _r(this, ht(this.doc, e), t || "page")
                    },
                    coordsChar: function(e, t) {
                        return Qr(this, (e = $r(this, e, t || "page")).left, e.top)
                    },
                    ...
                    heightAtLine: function(e, t, r) {
                        ...
                        return Yr(this, n, {
                            top: 0,
                            left: 0
                        }, t || "page", r || i).top + (i ? this.doc.height - Yt(n) : 0)
                    },
                    ...
                    addWidget: function(e, t, r, n, i) {
                        var o = this.display
                          , l = (e = qr(this, ht(this.doc, e))).bottom
                          , s = e.left;
                        ...
                        r && function(e, t) {
                            ...
                            null != r.scrollLeft && In(e, r.scrollLeft)
                        }(this, {
                            left: s,
                            top: l,
                    ...
                    triggerOnKeyDown: ri(hl),
                    triggerOnKeyPress: ri(dl),
                    triggerOnKeyUp: fl,
                    triggerOnMouseDown: ri(ml),
                    execCommand: function(e) {
                        if (rl.hasOwnProperty(e))
                            return rl[e].call(null, this)
                    },
                    ...
                    findPosH: function(e, t, r, n) {
                        ...
                        t < 0 && (i = -1,
                        t = -t);
                        for (var o = ht(this.doc, e), l = 0; l < t && !(o = Il(this.doc, o, i, r, n)).hitSide; ++l)
                            ;
                        return o
                    },
                    ...
                    deleteH: ri(function(e, t) {
                        var r = this.doc.sel
                          , n = this.doc;
                        r.somethingSelected() ? n.replaceSelection("", null, "+delete") : Jo(this, function(r) {
                    ...
                    moveV: ri(function(e, t) {
                        ...
                        if (n.extendSelectionsBy(function(l) {
                            ...
                            var s = qr(r, l.head, "div");
                            null != l.goalColumn && (s.left = l.goalColumn),
                            i.push(s.left);
                            var a = Bl(r, s, e, t);
                            return "page" == t && l == n.sel.primary() && Wn(r, _r(r, a, "div").top - s.top),
                            a
                        }, q),
                        i.length)
                    ...
                    findWordAt: function(e) {
                        ...
                        if (r) {
                            ...
                            for (var l = r.charAt(n), s = le(l, o) ? function(e) {
                                return le(e, o)
                            }
                            : /\s/.test(l) ? function(e) {
                                return /\s/.test(e)
                        ...
                        return new Li(it(e.line, n),it(e.line, i))
                    },
                    toggleOverwrite: function(e) {
                        null != e && e == this.state.overwrite || ((this.state.overwrite = !this.state.overwrite) ? F(this.display.cursorDiv, "CodeMirror-overwrite") : M(this.display.cursorDiv, "CodeMirror-overwrite"),
                        we(this, "overwriteToggle", this, this.state.overwrite))
                    },
                    hasFocus: function() {
                        return this.display.input.getField() == H(z(this))
                    },
                    isReadOnly: function() {
                    ...
                    getScrollInfo: function() {
                        ...
                        return {
                            left: e.scrollLeft,
                            top: e.scrollTop,
                            height: e.scrollHeight - Or(this) - this.display.barHeight,
                            width: e.scrollWidth - Or(this) - this.display.barWidth,
                    ...
                    scrollIntoView: ri(function(e, t) {
                        ...
                        }(this, e) : En(this, e.from, e.to, e.margin)
                    }),
                    ...
                    refresh: ri(function() {
                        ...
                        ci(this.display),
                        (null == e || Math.abs(e - on(this.display)) > .5 || this.options.lineWrapping) && cn(this),
                        we(this, "refresh", this)
                    }),
            ...
            for (var $l in Wo.prototype)
                Wo.prototype.hasOwnProperty($l) && j(Yl, $l) < 0 && (Nl.prototype[$l] = function(e) {
                    return function() {
            ...
            Nl.defineMode = function(e) {
                Nl.defaults.mode || "null" == e || (Nl.defaults.mode = e),
                function(e, t) {
            ...
            Nl.defineMIME("text/plain", "null"),
            Nl.defineExtension = function(e, t) {
                Nl.prototype[e] = t
            }
            ,
            ...
            function(e) {
                ...
                e.StringStream = _e,
                e.SharedTextMarker = No,
                e.TextMarker = To,
                e.LineWidget = So,
                e.e_preventDefault = ke,
